...
// jwtService.getLayoutSettings() !== null
//   ? jwtService.getLayoutSettings()
//   : getInitialSettings();
...
function getInitialSettings() {
  ...
  const layout = {
    ...
    config: {
      ...
      navbar: {
        display: true,
        folded  : false, //to always open false, default is false
        // position: "left",
      },
      toolbar: {
        display: true,
      ...
      mode: "fullwidth",
    }//FuseLayoutConfigs[defaultLayoutStyle].defaults,
  };
  return _.merge(
    {},
    defaultSettings,
...
function getInitialThemes() {
  const themesObj = defaultThemes; //Object.keys(FuseThemesConfig).length !== 0 ? FuseThemesConfig : defaultThemes;
