...
function NavbarMobileLayout2(props)
{
    ...
    return (
        <div className="flex flex-col h-full overflow-hidden" style={{marginBottom:'30%'}}>
            <AppBar
                color="primary"
                position="static"
                elevation={0}
                className="flex flex-row items-center flex-shrink h-64 min-h-64 pl-20 pr-12 respon-nav"
