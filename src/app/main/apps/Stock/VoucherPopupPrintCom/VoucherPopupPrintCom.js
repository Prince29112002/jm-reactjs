...
export class VoucherPopupPrintCom extends React.PureComponent {
  componentDidMount() {}

  render() {
    const { printObj, StockType, printData } = this.props;
    console.log(printObj, printData);
...
export const FunctionalComponentToPrint = React.forwardRef((props, ref) => {
  ...
  return <VoucherPopupPrintCom ref={ref} printObj={props.printObj} />;
});
