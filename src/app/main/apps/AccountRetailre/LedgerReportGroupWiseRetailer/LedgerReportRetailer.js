...
const LedgerReportRetailer = (props) => {
  ...
  function getVoucherSearchApi(sData) {
    axios
      .get(Config.getCommonUrl() + `retailerProduct/api/ledger/group/ledger/0/${sData}`)
      ...
      .catch((error) => {
        handleError(error, dispatch, {
          api: `retailerProduct/api/ledger/group/ledger/0/${sData}`,
        });
      });
  }
        ...
        <div className="flex flex-col md:flex-row container">
          <div className="flex flex-1 flex-col min-w-0 makeStyles-root-1">
            ...
            <div className="main-div-alll ">
              ...
              >
                <Grid item lg={3} md={4} sm={4} xs={12} style={{ position: "relative"}}>
                  <p>Search ledger</p>
                  <Autocomplete
                    id="free-solo-demo"
                    freeSolo
                  ...
                  />
                  <span style={{ color: "red" }} className={classes.errorMessage}>
                ...
                <Grid
                  ...
                  sm={6}
                  xs={12}
                  style={{ alignItems: "flex-start", display: "flex", marginTop: "16px" }}
                >
                  <Button
              ...
              <div className="mt-20 ledge_report_group_header ledge_report_group_header-tabl">
...
export default LedgerReportRetailer;
