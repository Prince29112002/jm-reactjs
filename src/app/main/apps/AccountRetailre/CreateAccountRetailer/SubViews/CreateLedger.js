...
const CreateLedger = (props) => {
  ...
  function getGroupList() {
    axios
      .get(Config.getCommonUrl() + "retailerProduct/api/group")
      .then((res) => {
        console.log(res);
        setUnderGroupList(res.data.data);
      })
      .catch((error) => {
        handleError(error, dispatch, { api: "retailerProduct/api/group" });
      });
  }

  function getMainHeadList() {
    axios
      .get(Config.getCommonUrl() + "retailerProduct/api/mainhead")
      .then((res) => {
        console.log(res);
        setMainHeadList(res.data.data);
      })
      .catch((error) => {
        handleError(error, dispatch, { api: "retailerProduct/api/mainhead" });
      });
  }

  function getDataForEdit(id) {
    axios
      .get(Config.getCommonUrl() + `retailerProduct/api/ledger/view/${id}`)
      .then((res) => {
        if (res.data.success) {
          console.log(res);
      ...
      .catch((error) => {
        handleError(error, dispatch, {
          api: `retailerProduct/api/ledger/view/${id}`,
        });
      });
  }
  ...
  const handleInputChange = (event) => {
    ...
    if (name === "ledgerName") {
      ...
      setIFSCcode(value);
      if (!value || IFSCRegex.test(value) === false) {
      ...
      setPanNumber(value);
      if (!value || panNumRegex.test(value) === false) {
      ...
      setPincode(value);
      if (!value || pincodeRegex.test(value) === false) {
      ...
      setAccNumber(value);
      if (!value || numberRegex.test(value) === false) {
      ...
      setGstNumber(value);
      if (!value || gstRegex.test(value) === false) {
        setGstNumErr("Enter valid GST number");
      } else {
        setGstNumErr("");
      }
    }
  ...
  function callAddLedgerApi() {
    ...
    axios
      .post(Config.getCommonUrl() + "retailerProduct/api/ledger", body)
      .then((response) => {
      ...
      .catch((error) => {
        handleError(error, dispatch, {
          api: "retailerProduct/api/ledger",
          body: body,
        });
      });
  }
  ...
  function callUpdateLedgerApi() {
    ...
    axios
      .put(
        Config.getCommonUrl() + `retailerProduct/api/ledger/${ledgerId}`,
        body
      )
      .then((response) => {
        console.log(response);
      ...
      .catch((error) => {
        handleError(error, dispatch, {
          api: `retailerProduct/api/ledger/${ledgerId}`,
          body: body,
        });
      });
  }
  ...
  function getStatedata(countryID) {
    axios
      .get(
        Config.getCommonUrl() + "retailerProduct/api/country/state/" + countryID
      )
      .then(function (response) {
        if (response.data.success === true) {
          console.log(response);
      ...
      .catch((error) => {
        handleError(error, dispatch, {
          api: "retailerProduct/api/country/state/" + countryID,
        });
      });
  }
