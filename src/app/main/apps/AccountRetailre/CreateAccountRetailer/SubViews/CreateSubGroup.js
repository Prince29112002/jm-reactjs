...
const CreateSubGroup = (props) => {
  ...
  function getGroupList() {
    axios.get(Config.getCommonUrl() + "retailerProduct/api/group?isparent=1")
      .then((res) => {
        console.log(res);
      ...
      .catch((error) => {
        handleError(error, dispatch, {api : "retailerProduct/api/group?isparent=1"})
  ...
  function callUpdateSubGroupApi() {
    ...
    axios.put(Config.getCommonUrl() + `retailerProduct/api/subgroup/${id}`, body)
      .then((response) => {
      ...
      .catch((error) => {
        handleError(error, dispatch,{api:`retailerProduct/api/subgroup/${id}`, body: body})

      })
  }

  function callAddSubGroupApi() {
    axios.post(Config.getCommonUrl() + "retailerProduct/api/subgroup", {
      name: groupName,
      groups_id: selectedGroup.value,
      account_type: accountType
    })
      ...
      .catch((error) => {
        handleError(error, dispatch, {api : "retailerProduct/api/subgroup", body :{
          name: groupName,
          groups_id: selectedGroup.value,
          account_type: accountType
        }})
