...
const CreateGroup = (props) => {
  ...
  function callAddVoucherApi() {
    axios.post(Config.getCommonUrl() + "retailerProduct/api/vouchersettingdetail/", {
      name: voucherName
    })
      .then((response) => {
        ...
        if (response.data.success) {
          setVoucherName("");
          dispatch(Actions.showMessage({ message: "Voucher Added Successfully",variant:"success" }));
      ...
      .catch((error) => {
        handleError(error, dispatch, { api : "retailerProduct/api/vouchersettingdetail/",body: {
          name: voucherName
        }})
    ...
    <div>
      ...
      >
        ...
        style={{padding:"10px"}}
          ...
          <div className="pl-16 pr-16" style={{padding:"20px"}}>
            ...
            <TextField
              ...
              fullWidth
            />
            <div className="flex flex-row justify-around" style={{paddingTop:"20px", columnGap:"20px"}}>
              <Button
                variant="contained"
