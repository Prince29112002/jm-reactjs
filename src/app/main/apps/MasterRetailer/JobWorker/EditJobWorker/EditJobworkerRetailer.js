...
const EditJobworkerRetailer = (props) => {
  const dataToBeEdited = props.location.state;
  console.log(dataToBeEdited,"111111111111111111111111111111111111111111111111111111111111111111111");
  ...
  function callEditJobWorkerApi() {
    ...
    axios
      .put(
        Config.getCommonUrl() + "retailerProduct/api/jobworkerRet/update/" + dataToBeEdited.row.id,
        data
      )
      ...
      .catch((error) => {
        handleError(error, dispatch, {
          api: "retailerProduct/api/jobworkerRet/update/" + dataToBeEdited.row.id,
          body: data,
        });
      });
  }
          ...
          <div className="flex flex-1 flex-col min-w-0 makeStyles-root-1 pt-20 ">
            ...
            <div className="main-div-alll ">
              ...
              <div>
                ...
                >
                   <h4 className="mb-10">Job Worker Details</h4>

                  <div className="w-full mb-16 flex flex-row flex-wrap add-client-row ">
                  ...
                  <h4 className="mb-10">Bank Details</h4>

                  <div className="w-full flex flex-row flex-wrap  add-client-row ">
                    <div className="add-textfiled">
                      <p>Bank name</p>
                      <TextField
                        className=""
...
export default EditJobworkerRetailer;
