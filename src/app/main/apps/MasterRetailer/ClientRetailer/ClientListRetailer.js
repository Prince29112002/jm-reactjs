...
const ClientList = (props) => {
  ...
  : null;
    ...
    useEffect(() => {
      let arr = roleOfUser
          ? roleOfUser["Master-Retailer"]["Client-Retailer"]
            ? roleOfUser["Master-Retailer"]["Client-Retailer"]
            : []
          : [];
      const arrData = [];
  ...
  function editHandler(row) {
    props.history.push("/dashboard/mastersretailer/editclientretailer", {
      row: row,
      isViewOnly: false,
    });
  }
        ...
        <div className="flex flex-col md:flex-row container">
          <div className="flex flex-1 flex-col min-w-0 makeStyles-root-1 pt-20 ">
            <Grid
              container
              alignItems="center"
              style={{paddingInline: 30, paddingBottom: 20, justifyContent: "space-between"}}
            >
              ...
              >
                <Button
                  ...
                  size="small"
                  onClick={() => History.push('/dashboard/mastersretailer/clientsretailer/addclientretailer')}
                >
                  Add New
                </Button>
              </Grid>
