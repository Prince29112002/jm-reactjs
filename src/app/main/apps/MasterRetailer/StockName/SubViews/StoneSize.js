...
const StoneSize = (props) => {
  ...
  function callAddStoneSizeApi() {
    axios
      .post(Config.getCommonUrl() + "retailerProduct/api/stonesize", {
        size: StoneSize,
      })
      .then(function (response) {
        console.log(response);
      ...
      .catch((error) => {
        handleError(error, dispatch, {
          api: "retailerProduct/api/stonesize",
          body: {
            size: StoneSize,
          },
        });
  ...
  function callEditStoneSizeApi() {
    ...
    axios
      .put(Config.getCommonUrl() + "retailerProduct/api/stonesize/" + selectedIdForEdit, {
        size: editStoneSize,
      })
      .then(function (response) {
        console.log(response);
      ...
      .catch((error) => {
        handleError(error, dispatch, {
          api: "retailerProduct/api/stonesize/" + selectedIdForEdit,
          body: {
            size: editStoneSize,
          },
        });
  ...
  function callDeleteStoneSizeApi() {
    axios
      .delete(Config.getCommonUrl() + "retailerProduct/api/stonesize/" + selectedIdForDelete)
      .then(function (response) {
        console.log(response);
        setOpen(false);
        if (response.data.success === true) {
      ...
      .catch((error) => {
        handleError(error, dispatch, {
          api: "retailerProduct/api/stonesize/" + selectedIdForDelete,
        });
      });
  }
    ...
    <div className={clsx(classes.root, props.className)}>
      ...
      >
        <div className="flex flex-1 flex-col min-w-0 ">
          ...
          >
            <div>
              {authAccessArr.includes('Add Stone Size-Retailer') &&
              ...
              <TableBody>
                ...
                .toLowerCase().includes(searchData.toLowerCase())
                  ...
                  <TableRow key={row.id}>
                    ...
                    <TableCell className={classes.tableRowPad}>
              {authAccessArr.includes('Edit Stone Size-Retailer') &&
...
{authAccessArr.includes('Delete Stone Size-Retailer') &&
