...
const StockNameDesc = (props) => {
  ...
  function getDescList() {
    axios
      .get(Config.getCommonUrl() + "retailerProduct/api/stockdescription")
      ...
      .catch(function (error) {
        handleError(error, dispatch, { api: "retailerProduct/api/stockdescription" });
      });
  }
  ...
  function callDeleteDescApi() {
    axios
      .delete(
        Config.getCommonUrl() + "retailerProduct/api/stockdescription/" + selectedIdForDelete
      )
      .then(function (response) {
        console.log(response);
        setOpen(false);
      ...
      .catch((error) => {
        handleError(error, dispatch, {
          api: "retailerProduct/api/stockdescription/" + selectedIdForDelete,
        });
      });
  }
  ...
  function CallAddDescApi() {
    axios
      .post(Config.getCommonUrl() + "retailerProduct/api/stockdescription", {
      ...
      .catch((error) => {
        handleError(error, dispatch, {
          api: "retailerProduct/api/stockdescription",
          body: {
            description: stockNmDesc,
            stock_name_id: selectedStockNm.value,
            pcs_require: stockNmPieces,
  ...
  function CallEditDescApi() {
    axios
      .put(
        Config.getCommonUrl() + "retailerProduct/api/stockdescription/" + selectedIdForEdit,
        {
          description: stockNmDesc,
          stock_name_id: selectedStockNm.value,
          pcs_require: stockNmPieces,
      ...
      .catch((error) => {
        handleError(error, dispatch, {
          api: "retailerProduct/api/stockdescription/" + selectedIdForEdit,
          body: {
            description: stockNmDesc,
            stock_name_id: selectedStockNm.value,
            pcs_require: stockNmPieces,
          ...
          <div className="flex flex-1 flex-col min-w-0">
            ...
            >
              ...
              >
                ...
                > */}
                {authAccessArr.includes('Add Stock Name Description-Retailer') && 
                <Button
                  variant="contained"
                      ...
                      .map((row) => (
                        <TableRow key={row.id}>
                          ...
                          <TableCell
                            ...
                            style={{ maxWidth: 200 }}
                          >
                            {authAccessArr.includes('Edit Stock Name Description-Retailer') && 
                            <IconButton
                              style={{ padding: "0" }}
                              onClick={(ev) => {
                                ev.preventDefault();
                            ...
                            {authAccessArr.includes('Delete Stock Name Description-Retailer') && 
