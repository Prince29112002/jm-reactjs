...
const AddNewStock = (props) => {
  ...
  function callAddNewStockApi() {
    axios
      .post(Config.getCommonUrl() + "retailerProduct/api/stockname", {
      ...
      .catch((error) => {
        handleError(error, dispatch, {
          api: "retailerProduct/api/stockname",
          body: {
            stock_group_id: parseInt(stockGroupSelected.value),
            stock_name: stockName,
            billing_name: billStkNm,
      ...
      >
        <div style={modalStyle} className={clsx(classes.paper, "rounded-8")}>
          ...
          <div style={{padding: "16px"}}>
            <p className="popup-labl">Stock group</p>
            <Select
            ...
            <p className="popup-labl" style={{ marginTop: "15px"}}>Stock name</p>
            <TextField
              className="input-select-bdr-dv"
            ...
            <p className="popup-labl" style={{ marginTop: "15px"}}>Billing stock name</p>
            <TextField
              className="input-select-bdr-dv"
            ...
            <p className="popup-labl" style={{ marginTop: "15px"}}>HSN</p>
            <Select
              filterOption={createFilter({ ignoreAccents: false })}
              className="input-select-bdr-dv"
              classes={classes}
            ...
            <p className="popup-labl" style={{ marginTop: "15px"}}>GST</p>
            <TextField
              className="input-select-bdr-dv"
