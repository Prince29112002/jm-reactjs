...
const GoldColor = (props) => {
  ...
  function callAddGoldColorApi() {
    axios
      .post(Config.getCommonUrl() + "retailerProduct/api/goldcolor", {
        name: GoldColor,
      })
      .then(function (response) {
        console.log(response);
      ...
      .catch((error) => {
        handleError(error, dispatch, {
          api: "retailerProduct/api/goldcolor",
          body: {
            name: GoldColor,
          },
        });
  ...
  function callEditGoldColorApi() {
    axios
      .put(Config.getCommonUrl() + "retailerProduct/api/goldcolor/" + selectedIdForEdit, {
        name: editGoldColor,
      })
      .then(function (response) {
        console.log(response);
      ...
      .catch((error) => {
        handleError(error, dispatch, {
          api: "retailerProduct/api/goldcolor/" + selectedIdForEdit,
          body: {
            name: editGoldColor,
          },
        });
  ...
  function callDeleteStoneSizeApi() {
    axios
      .delete(Config.getCommonUrl() + "retailerProduct/api/goldcolor/" + selectedIdForDelete)
      .then(function (response) {
        setOpen(false);
        if (response.data.success === true) {
          // selectedIdForDelete
      ...
      .catch((error) => {
        handleError(error, dispatch, {
          api: "retailerProduct/api/goldcolor/" + selectedIdForDelete,
        });
      });
  }
    ...
    <div className={clsx(classes.root, props.className)}>
      ...
      >
        <div className="flex flex-1 flex-col min-w-0">
          ...
          >
            <div>
              {authAccessArr.includes('Add Gold Color-Retailer') &&
                ...
                {apiData
                  ...
                  .map((row) => (
                    <TableRow key={row.id}>
                      ...
                      <TableCell className={classes.tableRowPad}>
              {authAccessArr.includes('Edit Gold Color-Retailer') &&
                        ...
                        {authAccessArr.includes('Delete Gold Color-Retailer') &&
