...
const StockNameRetailer = (props) => {
  ...
  useEffect(() => {
    let arr = roleOfUser
        ? roleOfUser["Master-Retailer"]["Stock Name-Retailer"]
          ? roleOfUser["Master-Retailer"]["Stock Name-Retailer"]
          : []
        : [];
    const arrData = [];
  ...
  const ButtonArr = [
    { id: 7, text: "Add Stock Code" , isAccess : authAccessArr.includes('Add Stock Code-Retailer')},
    { id: 8, text: "Add New Stock" ,isAccess : authAccessArr.includes('Add New Stock-Retailer')},
  ];
            ...
            <div className="main-div-alll" style={{ marginTop: "20px" , paddingTop: "10px"}}>
              <div>
                ...
                >
                  ...
                  {(authAccessArr.includes('Add Stone Size-Retailer') || authAccessArr.includes('Edit Stone Size-Retailer') || authAccessArr.includes('Delete Stone Size-Retailer')) &&
                  <Tab className={classes.tab} label="Stone Size" />}

                 {( authAccessArr.includes('Add Stone Shape-Retailere') || authAccessArr.includes('View Stone Shape-Retailer') || authAccessArr.includes('Delete Stone Shape-Retailer'))&&
                  <Tab className={classes.tab} label="Stone Shape" />}

                {  (authAccessArr.includes('Add Stone Color-Retailer') || authAccessArr.includes('View Stone Color-Retailer') || authAccessArr.includes('Delete Stone Color-Retailer') || authAccessArr.includes('Edit Stone Color-Retailer'))&&
                  <Tab className={classes.tab} label="Stone Color" />}

                 {  (authAccessArr.includes('Add Gold Color-Retailer') || authAccessArr.includes('View Gold Color-Retailer') || authAccessArr.includes('Delete Stone Color-Retailer')|| authAccessArr.includes('Edit Stone Color-Retailer'))&&
                  <Tab className={classes.tab} label="Gold Color" />}

                   {(authAccessArr.includes('Add Unit-Retailer') || authAccessArr.includes('View Unit-Retailer'))&&
                  <Tab className={classes.tab} label="Unit" />}

                 {( authAccessArr.includes('Add Stock Name Description-Retailer') || authAccessArr.includes('View Stock Name Description-Retailer') || authAccessArr.includes('Delete Stock Name Description-Retailer'))&&
              ...
              {defaultView === 0 && (
                <StockNameView
                  ...
                  search={searchData}
                  permitArr={authAccessArr}
                />
              )}
              {defaultView === 1 && <StoneSize permitArr={authAccessArr}/>}
              {defaultView === 2 && <StoneShape permitArr={authAccessArr}/>}
              {defaultView === 3 && <StoneColor permitArr={authAccessArr}/>}
              {defaultView === 4 && <GoldColor permitArr={authAccessArr}/>}
              {defaultView === 5 && <Unit permitArr={authAccessArr}/>}
              {defaultView === 6 && <StockNameDesc permitArr={authAccessArr}/>}
              {defaultView === 7 && (
                <CreateStockCode modalColsed={handleClose} />
              )}
              {defaultView === 8 && <AddNewStock modalColsed={handleClose} permitArr={authAccessArr}/>}
...
export default StockNameRetailer;
