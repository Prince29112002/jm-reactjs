...
const LedgerRepAcc = (props) => {
  ...
  function getVoucherSearchApi(sData) {
    axios
      .get(Config.getCommonUrl() + `api/ledger/group/ledger/1/${sData}`)
      ...
      .catch((error) => {
        handleError(error, dispatch, {
          api: `api/ledger/group/ledger/1/${sData}`,
        });
      });
  }
        ...
        <div className="flex flex-col md:flex-row container">
          <div className="flex flex-1 flex-col min-w-0 makeStyles-root-1" style={{marginTop: "30px"}}>
            ...
            <div className="main-div-alll" style={{marginTop: "20px"}}>
              ...
              <div className="accountledgerstatement-tbl ledge_report_group_header-tabl overflow-x-auto" style={{marginTop: "20px"}}>
