...
const CreateGroup = (props) => {
  ...
  function getMainGroupList() {
    axios.get(Config.getCommonUrl() + "api/maingroup")
      .then((res) => {
        console.log(res);
      ...
      .catch((error) => {
        handleError(error, dispatch, { api: "api/maingroup" })
  ...
  function callAddGroupApi() {
    axios.post(Config.getCommonUrl() + "api/group", {
      name: groupName,
  ...
  function callUpdateGroupApi() {
    ...
    axios.put(Config.getCommonUrl() + `api/group/${id}`, body)
      .then((response) => {
        console.log(response);
        if (response.data.success) {
          setGroupName("");
      ...
      .catch((error) => {
        handleError(error, dispatch, { api: `api/group/${id}`, body: body })
      ...
      >
        ...
        >
          ...
          <div style={{padding: "30px"}}>
            <p className="popup-labl pb-4" style={{paddingLeft: "15px"}}>Group Name</p>
            <TextField
              ...
              fullWidth
            />
            <p className="popup-labl pb-4" style={{paddingLeft: "15px"}}>Select Group</p>
            <Select
              // className="mt-16"
              // styles={selectStyles}
          ...
          <FormControlLabel  
            ...
            <div className="flex flex-row justify-between" style={{paddingTop: "30px"}}>
              <Button
                variant="contained"
