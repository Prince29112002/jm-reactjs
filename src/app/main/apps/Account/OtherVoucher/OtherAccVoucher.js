...
import CreateVoucher from "../Voucher/SubViews/CreateVoucher";
...
const OtherAccVoucher = (props) => {
    ...
    useEffect(() => {
      ...
      function getAllVoucherList() {
        setLoading(true);
        axios.get(Config.getCommonUrl() + "api/vouchersettingdetail")
          .then((response) => {
          ...
          .catch((error) => {
            setLoading(false);
            handleError(error, dispatch, {api : "api/vouchersettingdetail"})
          })
      }
      ...
      function callDeleteApi() {
        axios.delete(Config.getCommonUrl() + `api/vouchersettingdetail/${deleteId}`)
          .then((response) => {
            console.log(response);
          ...
          .catch((error) => {
            setOpen(false);
            handleError(error, dispatch, {api:`api/vouchersettingdetail/${deleteId}`})
          })
      }
      ...
      <FuseAnimate animation="transition.slideUpIn" delay={200}>
        ...
        <div className="flex flex-1 flex-col min-w-0 makeStyles-root-1" style={{marginTop: "30px"}}>
            ...
            >
              ...
              <Grid item xs={3} sm={3} md={4} key="2"
            ...
            {loading && <Loader />}
            {modalView === true && <CreateVoucher modalColsed={handleClose} />}

            <div className="mt-56">
              <Paper className={clsx(classes.tabroot, "table-responsive voucher-tbel-blg voucher-tbel-blg-dv createaccount-tbel-dv")}>
...
export default OtherAccVoucher