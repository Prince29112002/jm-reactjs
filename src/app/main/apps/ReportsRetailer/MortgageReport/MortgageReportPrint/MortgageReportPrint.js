...
import { LOGIN_ERROR } from "app/auth/store/actions";
export class MortgageReportPrint extends React.PureComponent {
  componentDidMount() {}
  render() {
    const { printObj } = this.props;
    // console.log(printObj.partialAmount);
          ...
          <div>
            ...
            <div style={{ margin: "5px" }}>
                  ...
                  <div style={{ flexBasis: "33.33%" }}>
                    ...
                    <h6>
                      {Object.keys(printObj).length !== 0 &&
                        printObj?.MortgageUser.name}
                    </h6>
                    <h6>Address : 
                      {Object.keys(printObj).length !== 0 &&
                        printObj?.MortgageUser?.address}
                    </h6>
                    <h6>Mo.No :
                      {Object.keys(printObj).length !== 0 &&
                        printObj?.MortgageUser?.mobile_number}
                    </h6>
                  </div>
              ...
              <div style={{ minHeight: 250 }}>
                {Object.keys(printObj).length !== 0 &&
                printObj?.MortagePartialEntry.length > 0 ? (
                  <div
                  ...
                  >
                    ...
                    {Object.keys(printObj).length !== 0 &&
                      printObj?.MortagePartialEntry.map((row, index) => {
                        console.log(row);
                        return (
                ...
                >
                  ...
                  <div className="row">
                    ...
                    >
                      ...
                      {
                        profileData?.is_mortgage_print !== 1 && <> <div style={{ maxWidth: 60 }}>
                  ...
                  {Object.keys(printObj).length !== 0 &&
                    printObj?.MortgageProducts.map((row, index) => {
                      console.log(row);
                      return (
                        <div className="row" key={index}>
                          <div className="body-tabel-deta">
                            ...
                            {
                              profileData?.is_mortgage_print !== 1 && <>
                               <div
                              border="1"
                ...
                {Object.keys(printObj).length !== 0 &&
                printObj?.MortgagePayments.length > 1 ? (
                  <div
                    className="tabel-deta-show"
                    style={{ height: "auto", marginBottom: 10 }}
                  >
                    ...
                    {Object.keys(printObj).length !== 0 &&
                      printObj?.MortgagePayments.filter(
                        (item) => item.is_added === 1
                      ).map((row, index) => {
                        console.log(row);
                        return (
                          <div className="row" key={index}>
              ...
              >
                ...
                >
                  ...
                  <h6 style={{ width: "40%" }}>
                    ...
                    {Object.keys(printObj).length !== 0 && printObj?.weight} gm
                  </h6>
                  <h6 style={{ width: "40%" }}>
                    <span style={{ display: "inline-block", width: "150px" }}>
                      Principle Amount :
                    ...
                    {Object.keys(printObj).length !== 0 &&
                      printObj?.principal_amount}
                  </h6>
                  {
                    profileData?.is_mortgage_print === 1 && <h6 style={{ width: "40%" }}>
                    <span style={{ display: "inline-block", width: "150px" }}>
                    Note :
                    </span>{" "}
                    {printObj?.notes}
                  ...
                  }
                  {
                    ...
                    {Object.keys(printObj).length !== 0 && printObj?.percentage}
                    %
                  </h6> : <h6 style={{ width: "40%" }}></h6>
                  }
                    {
                    profileData?.is_mortgage_print === 1 && 
                  <div style={{paddingTop: "10px"}}> <span style={{textAlign: "center"}}>पर्ची खो जाने पर सामान नहीं मिलेगा और दुकानदार की कोई ज़िम्मेदारी नहीं होगी। अवधी के अंदर ही सामान छुड़ाये।</span></div>
                  }
                </div>
              </div>
            </div>
...
export const FunctionalComponentToPrint = React.forwardRef((props, ref) => {
  ...
  return <MortgageReportPrint ref={ref} printObj={props.printObj} />;
});
