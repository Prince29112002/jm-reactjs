...
import { TextField, Icon, IconButton, Box, Grid } from "@material-ui/core";
...
const UploadFile = (props) => {
  ...
  function callFileUploadApi(formData) {
    ...
    if (props.karat) {
      ...
      var api = `api/productionorder/upload/neworder/csv`;
    } else {
      var api = `api/productionorder/order/upload/csv/${props.id}`;
    }
    const body = formData;
      ...
      >
        <Box className={classes.modalStyle}>
          ...
          <div className="p-5 pl-16 pr-16">
            ...
            />
            <Grid item lg={6} md={6} sm={6} xs={12} style={{ padding: 2 }}>
              <a href={sampleFile} download="Upload_New_Design.csv">
                Download Sample{" "}
              </a>
            </Grid>
