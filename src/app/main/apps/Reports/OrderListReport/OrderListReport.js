...
const OrderListReport = (props) => {
  ...
  function setFilters(tempPageNo) {
    ...
    let url = "api/productionreport/orders/list?";
    ...
    if (searchData.confirm_date !== "") {
      url = url + "&order_confirmed_date=" + searchData.confirm_date;
    }
              ...
              <Box style={{ paddingInline: 16, marginTop: 16 }}>
                ...
                >
                  ...
                  <Grid
                    ...
                    style={{ padding: 5 }}
                  >
                    <label>Order Confrim Date</label>
                    <TextField
                      // label="Order Confirm Date"
                      name="confirm_date"
                      value={searchData.confirm_date}
                      error={Boolean(searchData.errors.confirm_date)}
                      helperText={searchData.errors?.confirm_date}
                      type="date"
                      onChange={(e) => handleInputChange(e)}
                      variant="outlined"
                      fullWidth
