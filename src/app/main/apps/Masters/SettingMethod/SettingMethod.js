...
const SettingMethod = (props) => {
  ...
  function getMethodData() {
    setLoading(true);
    axios
      .get(Config.getCommonUrl() + "api/designDropDown?flag=1")
      ...
      .catch((error) => {
        setLoading(false);
        handleError(error, dispatch, { api: "api/designDropDown?flag=1" });
      });
  }

  function validateSettingName() {
    if (methodName === "") {
      setMethodNameErr("Please Enter setting method name");
      return false;
    }
    return true;
  }
  ...
  function callAddDetailsApi() {
    const body = { method: methodName };
    axios
      .post(Config.getCommonUrl() + `api/designDropDown/settingMethod`, body)
      .then(function (response) {
      ...
      .catch((error) => {
        handleError(error, dispatch, {
          api: `api/designDropDown/settingMethod`,
          body: body,
        });
      });
  }
            ...
            >
              ...
              >
                ...
                <div className="pl-32 pr-32 pb-10 pt-10">
                  <p className="popup-labl mt-16">Setting Method Name</p>
                  <TextField
                    className="mt-4 input-select-bdr-dv"
                    placeholder="Enter Setting Method Name"
                    name="methodName"
                    value={methodName}
