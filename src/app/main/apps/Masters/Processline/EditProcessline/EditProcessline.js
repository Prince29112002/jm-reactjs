...
const EditProcessline = (props) => {
  ...
  useEffect(() => {
    ...
    if (dataToBeEdited !== undefined) {
      console.log(dataToBeEdited.row);
      process();
      console.log(
        "/////////////////////////////////////////////////////////////"
      );
  ...
  function process() {
    axios
      .get(Config.getCommonUrl() + `api/processline/${dataToBeEdited.row.id}`)
      .then(function (response) {
        ...
        if (response.data.success === true) {
          ...
          setprocessName(data.process_line_name);
          // setSelectedcategory({
          //     value:data.process_category.id,
          //     label:data.process_category.category_name
          // })
          console.log(data.process_line);

          const processData = data.process_line.map((x) => {
            return {
              id: x.id,
              value: x.process_main ? x.process_main.id : null,
              label: x.process_main ? x.process_main.process_name : null,
              errors: {
                label: null,
              },
            };
      ...
      .catch(function (error) {
        handleError(error, dispatch, {
          api: `api/processline/${dataToBeEdited.row.id}`,
        });
      });
  }
  ...
  function callEditWorkStationApi() {
    // console.log(workStationformValues);
    // console.log(processDataformValues);
    ...
    // console.log(workerData);
    axios
      .put(Config.getCommonUrl() + "api/processline/" + dataToBeEdited.row.id, {
        // code: vendorCode,
                  ...
                  >
                    ...
                    <Grid container spacing={2}>
                      ...
                      <Select
                        ...
                        classes={classes}
                        styles={selectStyles}
                        options={categoryData.map((suggestion) => ({
                          value: suggestion.id,
...
export default EditProcessline;
