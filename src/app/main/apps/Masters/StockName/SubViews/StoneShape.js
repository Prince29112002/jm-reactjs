...
const StoneShape = (props) => {
  ...
  function callAddStoneShapeApi() {
    axios
      .post(Config.getCommonUrl() + "api/stoneshape", {
        name: StoneShape,
      })
      .then(function (response) {
        console.log(response);
  ...
  function callEditStoneShapeApi() {
    ...
    axios
      .put(Config.getCommonUrl() + "api/stoneshape/" + selectedIdForEdit, {
        name: editStoneShape,
      })
      .then(function (response) {
        console.log(response);
      ...
      .catch((error) => {
        handleError(error, dispatch, {
          api: "api/stoneshape/" + selectedIdForEdit,
          body: {
            name: editStoneShape,
          },
        });
  ...
  function callDeleteStoneShapeApi() {
    axios
      .delete(Config.getCommonUrl() + "api/stoneshape/" + selectedIdForDelete)
      .then(function (response) {
        console.log(response);
        setOpen(false);
        if (response.data.success === true) {
      ...
      .catch((error) => {
        handleError(error, dispatch, {
          api: "api/stoneshape/" + selectedIdForDelete,
        });
      });
  }
