...
const StoneColor = (props) => {
  ...
  function callAddStoneSizeApi() {
    axios
      .post(Config.getCommonUrl() + "api/stonecolor", {
        name: StoneColor,
      })
      .then(function (response) {
        console.log(response);
  ...
  function callEditStoneColorApi() {
    axios
      .put(Config.getCommonUrl() + "api/stonecolor/" + selectedIdForEdit, {
        name: editStoneColor,
      })
      .then(function (response) {
        console.log(response);
      ...
      .catch((error) => {
        handleError(error, dispatch, {
          api: "api/stonecolor/" + selectedIdForEdit,
          body: {
            name: editStoneColor,
          },
        });
  ...
  function callDeleteStoneSizeApi() {
    axios
      .delete(Config.getCommonUrl() + "api/stonecolor/" + selectedIdForDelete)
      .then(function (response) {
        console.log(response);
        setOpen(false);
        if (response.data.success === true) {
      ...
      .catch((error) => {
        handleError(error, dispatch, {
          api: "api/stonecolor/" + selectedIdForDelete,
        });
      });
  }
