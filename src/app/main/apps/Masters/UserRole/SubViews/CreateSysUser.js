...
const CreateSysUser = (props) => {
  ...
  useEffect(() => {
    ...
    axios
      .get(Config.getCommonUrl() + "admin/permission")
      ...
      .catch(function (error) {
        handleError(error, dispatch, { api: "admin/permission" });
      });
      ...
      axios
        ...
        .catch(function (error) {
          handleError(error, dispatch, {
            api: "api/adminrole/" + idToBeEdited,
          });
        });
    }
    //eslint-disable-next-line
          ...
          <div className="flex flex-1 flex-col min-w-0">
            <div>
              <div style={{ width: "340px" }}>
                ...
                <label className="form-title-dv"> User name* </label>
