    ...
    axios
      ...
      .catch((error) => {
        handleError(error, dispatch, {
          api: "api/adminrole/" + selectedIdForDelete,
        });
      });
  }
              ...
              <Grid item xs={6} sm={4} md={3} key="1" style={{ padding: 0 }}>
                <FuseAnimate delay={300}>
                  {defaultView === "1" ? (
                    ...
                    <Typography className="pl-28 pt-16 text-18 font-700">
                      {isEdit === false ? "Create User Role" : "Edit User Role"}
                    </Typography>
                  )}
                </FuseAnimate>
              ...
              >
                {ButtonArr.map((btndata, idx) => {
                  if (defaultView != btndata.id) {
                    return btndata.text == "Create User Role" ? (
                      <Button
