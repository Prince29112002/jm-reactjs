...
const TypeOfSetting = (props) => {
  ...
  function getMethodData() {
    setLoading(true);
    axios
      .get(Config.getCommonUrl() + "api/designDropDown?flag=3")
      ...
      .catch((error) => {
        setLoading(false);
        handleError(error, dispatch, { api: "api/designDropDown?flag=3" });
      });
  }
  ...
  function callAddDetailsApi() {
    const body = { type_of_setting: methodName };
    axios
      .post(Config.getCommonUrl() + `api/designDropDown/typeOfSetting`, body)
      .then(function (response) {
        console.log(response);
        if (response.data.success === true) {
          dispatch(
      ...
      .catch((error) => {
        handleError(error, dispatch, {
          api: `api/designDropDown/typeOfSetting`,
          body: body,
        });
      });
  }
            ...
            >
              ...
              >
                <h5 className="popup-head p-20">
                  {isEdit === false
                    ? "Add New Type of Setting"
                    : "Edit Type of Setting"}
                  <IconButton
