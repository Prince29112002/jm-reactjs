...
import CreateDesignerRole from './subview/CreateDesignerRole';
...
const DesignerRole = (props) => {
  ...
  function callDeleteItemTypeApi() {
    axios
      .delete(Config.getCommonUrl() + "api/adminrole/" + selectedIdForDelete)
      ...
      .catch((error) => {
        handleError(error, dispatch, {api : "api/adminrole/" + selectedIdForDelete})
    ...
    <div className={clsx(classes.root, props.className, "w-full")}>
      ...
      <div className="flex flex-1 flex-col min-w-0 makeStyles-root-1 pt-20 ">
            ...
            >
              <Grid item xs={12} sm={4} md={3} key="1" style={{ padding: 0 }}>
                ...
                <Typography className="pl-28 pt-16 text-18 font-700">
                    Designer Role
                  </Typography>:<Typography className="pl-28 pt-16 text-18 font-700">
                   {isEdit === false ? "Create Designer Role" : "Edit Designer Role"}
                  </Typography>}
                </FuseAnimate>
              ...
              >
                {ButtonArr.map((btndata, idx) => {
                  if (defaultView != btndata.id) {
                    return btndata.text == "Create Role" ? (
                      <Button
          ...
          <IconButton type="submit" className={classes.iconButton} aria-label="search">
            ...
            {defaultView === 1 && (
              <div className="mt-56">
                <Paper className={clsx(classes.tabroot,"table-responsive ")} id="userrole-tabel-dv">
