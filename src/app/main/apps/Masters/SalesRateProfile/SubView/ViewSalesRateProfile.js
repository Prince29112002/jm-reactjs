...
const ViewSalesRateProfile = (props) => {
  ...
  function getPerticularTaggingRateProf() {
    ...
    axios
      .get(
        Config.getCommonUrl() +
          `api/salesRateProfile/getStock/${dataToBeEdited.id}`
      )
      ...
      .catch(function (error) {
        ...
        handleError(error, dispatch, {
          api: `api/salesRateProfile/getStock/${dataToBeEdited.id}`,
        });
      });
  }
...
export default ViewSalesRateProfile;
