...
import sampleFile from "app/main/SampleFiles/RateProfiles/Sales_Rate_Profile.csv";
...
const SalesRateProfile = (props) => {
  ...
  function viewHandler(id) {
    props.history.push("/dashboard/masters/viewsalesrateprofile", { id: id });
  }

  function callDeleteRateProfileApi() {
    axios
      .delete(
        Config.getCommonUrl() + "api/salesRateProfile/" + selectedIdForDelete
      )
      .then(function (response) {
        console.log(response);
        setOpen(false);
      ...
      .catch((error) => {
        handleError(error, dispatch, {
          api: "api/salesRateProfile/" + selectedIdForDelete,
        });
      });
  }
  ...
  function uploadfileapicall(f) {
    ...
    axios
      .post(Config.getCommonUrl() + "api/salesRateProfile/upload", formData)
      .then(function (response) {
        console.log(response);
      ...
      .catch((error) => {
        ...
        document.getElementById("fileinput").value = "";
        handleError(error, dispatch, {
          api: "api/salesRateProfile/upload",
        ...
        <div className="flex flex-1 flex-col min-w-0 makeStyles-root-1 pt-20 ">
          ...
          <div className="main-div-alll ">
            ...
            <div className="mt-56 department-tbl-mt-dv">
              <Paper
                className={clsx(classes.tabroot, "salesrateprofile_tabel_dv ")}
              >
          ...
          >
            ...
            >
              ...
              <h5 className="popup-head p-20">
                {isEdit === false
                  ? "Add New Sales Rate Profile"
                  : "Edit Sales Rate Profile"}
                <IconButton
              ...
              <div className="pl-32 pr-32 pb-10 pt-10">
                ...
                <div className="download-sample-link">
                  <a href={sampleFile} download="Sales_Rate_Profile.csv">
                    Download Sample{" "}
                  </a>
                </div>
                ...
                <div className="flex flex-row justify-between">
                  <Button
                    variant="contained"
                    className="w-136 mt-5 popup-cancel"
                    onClick={handleModalClose}
                  >
                    Cancel
                  </Button>
...
export default SalesRateProfile;
