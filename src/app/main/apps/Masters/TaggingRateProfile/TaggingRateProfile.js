...
import sampleFile from "app/main/SampleFiles/RateProfiles/Tag_Rate_profile.csv";
...
const TaggingRateProfile = (props) => {
  ...
  function getTaggingRateProfile() {
  ...
  function viewHandler(id) {
    ...
    props.history.push("/dashboard/masters/viewtaggingrateprofile", { id: id });
  }

  function callDeleteRateProfileApi() {
    axios
      .delete(
        Config.getCommonUrl() + "api/taggingRateProfile/" + selectedIdForDelete
      )
      .then(function (response) {
        console.log(response);
        setOpen(false);
      ...
      .catch((error) => {
        handleError(error, dispatch, {
          api: "api/taggingRateProfile/" + selectedIdForDelete,
        });
      });
  }
  ...
  function handleModalClose(callApi) {
    ...
    if (callApi === true) {
      getTaggingRateProfile(); //main list
    }
  }
  ...
  function uploadfileapicall(f) {
    ...
    axios
      .post(Config.getCommonUrl() + "api/taggingRateProfile/upload", formData)
      .then(function (response) {
        console.log(response);
      ...
      .catch((error) => {
        ...
        document.getElementById("fileinput").value = "";
        handleError(error, dispatch, {
          api: "api/taggingRateProfile/upload",
        ...
        <div className="flex flex-1 flex-col min-w-0 makeStyles-root-1 pt-20 ">
          ...
          <div className="main-div-alll ">
            ...
            <div className="mt-56 department-tbl-mt-dv">
              <Paper
                className={clsx(classes.tabroot, "taggingrateprofile_dv ")}
              >
          ...
          >
            ...
            >
              ...
              <h5 className="popup-head p-20">
                {isEdit === false
                  ? "Add New Tagging Rate Profile"
                  : "Edit Tagging Rate Profile"}
                <IconButton
              ...
              <div className="pl-32 pr-32 pb-10 pt-10">
                ...
                <div className="download-sample-link">
                  <a href={sampleFile} download="Tag_Rate_profile.csv">
                    Download Sample{" "}
                  </a>
                </div>
                ...
                <div className="flex flex-row justify-between">
                  <Button
                    variant="contained"
                    className="w-136 mt-5 popup-cancel delete-dialog-box-cancle-button"
                    onClick={handleModalClose}
                  >
                    Cancel
                  </Button>
                  <Button
                    variant="contained"
                    className="w-172 mt-5 popup-save"
                    onClick={handleClick}
                  >
                    upload a file
                  </Button>
...
export default TaggingRateProfile;
