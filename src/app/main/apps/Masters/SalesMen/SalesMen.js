...
const SalesMen = (props) => {
  ...
  function editHandler(row) {
    props.history.push("/dashboard/masters/editsalesman", {
      row: row,
      isViewOnly: false,
    });
  }
  ...
  function callDeleteSalesManApi() {
    axios
      .delete(Config.getCommonUrl() + "api/salesMan/" + selectedIdForDelete)
      ...
      .catch((error) => {
        handleError(error, dispatch, {
          api: "api/salesMan/" + selectedIdForDelete,
        });
      });
  }
  ...
  function getSalesMen() {
    axios
      .get(Config.getCommonUrl() + "api/salesMan")
      .then(function (response) {
        if (response.data.success === true) {
          console.log(response);
      ...
      .catch(function (error) {
        handleError(error, dispatch, { api: "api/salesMan" });
      });
  }
        ...
        <div className="flex flex-1 flex-col min-w-0 makeStyles-root-1 pt-20 ">
          <div className="flex flex-1 flex-col min-w-0">
            ...
            >
              ...
              >
                <Link
                  to="/dashboard/masters/addsalesman"
