...
const ItemType = (props) => {
  ...
  function callAddItemTypeApi() {
    //add item type
    axios
      .post(Config.getCommonUrl() + "api/itemtype", {
  ...
  function callEditItemTypeApi() {
    axios
      .put(Config.getCommonUrl() + "api/itemtype/" + selectedIdForEdit, {
        itemName: editItemNm,
      })
      .then(function (response) {
        console.log(response);
      ...
      .catch((error) => {
        handleError(error, dispatch, {
          api: "api/itemtype/" + selectedIdForEdit,
          body: {
            itemName: editItemNm,
          },
        });
  ...
  function callDeleteItemTypeApi() {
    axios
      .delete(Config.getCommonUrl() + "api/itemtype/" + selectedIdForDelete)
      .then(function (response) {
        console.log(response);
        setOpen(false);
        if (response.data.success === true) {
      ...
      .catch((error) => {
        setOpen(false);
        handleError(error, dispatch, {
          api: "api/itemtype/" + selectedIdForDelete,
        });
      });
  }
