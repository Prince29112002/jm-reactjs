...
const TagPrinter = (props) => {
  ...
  function MACAddressValidation() {
    ...
    if (systemMac === "") {
      setMacErr("Please Enter Valid Original Printer Name");
  ...
  function SystemNameValidation() {
    if (systemName === "") {
      ...
      setSystemNameErr("Please Enter Valid Printer Name");
  ...
  function callDeleteTagSystemApi() {
    axios
      .delete(Config.getCommonUrl() + "api/tagprinter/" + selectedIdForDelete)
      .then(function (response) {
        console.log(response);
        setOpen(false);
        if (response.data.success === true) {
      ...
      .catch((error) => {
        ...
        setOpen(false);
        handleError(error, dispatch, { api: "api/tagprinter/" + selectedIdForDelete })
      });
  }
  ...
  function callAddTagSystemDetailsApi() {
    //add item type
    axios
      .post(Config.getCommonUrl() + "api/tagprinter", {
        name: systemName,
  ...
  function callEditTagSystemDetailsApi() {
    axios
      .put(Config.getCommonUrl() + "api/tagprinter/" + selectedIdForEdit, {
        name: systemName,
        original_name: systemMac,
      })
      .then(function (response) {
      ...
      .catch((error) => {
        ...
        handleError(error, dispatch, {
          api: "api/tagprinter/" + selectedIdForEdit, body: {
            name: systemName,
            original_name: systemMac,
          }
        })
          ...
          <div className="flex flex-1 flex-col min-w-0">
            ...
            >
              <div style={modalStyle} className={clsx(classes.paper, "rounded-8")}>
                ...
                >
                  {isEdit === false ? "Add New Printer Details" : "Edit Printer Details"}
                  <IconButton
                ...
                <div className="p-32 pb-10">
                  <p className="popup-labl mt-16">Printer Name</p>
                  <TextField
