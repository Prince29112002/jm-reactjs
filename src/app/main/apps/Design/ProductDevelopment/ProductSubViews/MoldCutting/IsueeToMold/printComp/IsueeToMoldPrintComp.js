...
export class IsueeToMoldPrintComp extends React.PureComponent {
                ...
                <div className="" style={{ margin: 10 }}>
                    ...
                    <ul className="  ">
                        <li className="voucher_heading">
                            ...
                            <span>  Assign For Mold Cutting</span>
                            {/* </li> */}
                            {/* </ul> */}
                        </li>
                        <li className="d-block">
                            <ul className="voucher_details">
                                <li className="d-block">
                                    <span>
                                         <p>Voucher Num: <span>{printObj.voucherNum}</span> </p>
...
export const FunctionalComponentToPrint = React.forwardRef((props, ref) => {
    ...
    return <IsueeToMoldPrintComp ref={ref} printObj={props.printObj} />;
});
