...
export class ReceiveFromMoldPrintComp extends React.PureComponent {
            ...
            <div className="" style={{ margin: 10 }}>
              ...
              <ul className="  ">
                <li className="voucher_heading">
                  ...
                  <span>Mold Receive From Worker</span>
                  {/* </li> */}
                  {/* </ul> */}
                </li>
                <li className="d-block">
                  <ul className="voucher_details">
                    <li className="d-block">
                      <span>
                        ...
                        <p>Party Invoice Num:<span>{printObj.partyInvoiceNum}</span></p>
...
export const FunctionalComponentToPrint = React.forwardRef((props, ref) => {
    ...
    return <ReceiveFromMoldPrintComp ref={ref} printObj={props.printObj} />;
});
