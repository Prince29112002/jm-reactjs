...
export class MoldRejectionPRintComp extends React.PureComponent {
...
export const FunctionalComponentToPrint = React.forwardRef((props, ref) => {
    ...
    return <MoldRejectionPRintComp ref={ref} printObj={props.printObj} />;
});
