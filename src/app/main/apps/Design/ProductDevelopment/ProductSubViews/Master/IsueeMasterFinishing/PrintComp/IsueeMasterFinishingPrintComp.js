...
export class IsueeMasterFinishingPrintComp extends React.PureComponent {
                ...
                <div className="" style={{ margin: 10 }}>
                    ...
                    <ul className="  ">
                        <li className="voucher_heading">
                            ...
                            <span>Assign For Master Finish</span>
                            {/* </li> */}
                            {/* </ul> */}
                        </li>
                        <li className="d-block">
...
export const FunctionalComponentToPrint = React.forwardRef((props, ref) => {
    ...
    return <IsueeMasterFinishingPrintComp ref={ref} printObj={props.printObj} />;
});
