...
export class ReceiveWorkerMasterPrintCom extends React.PureComponent {
  componentDidMount() {}
  render() {
        ...
        <div className="" style={{ margin: 10 }}>
          ...
          <ul className="  ">
            <li className="voucher_heading">
              ...
              <span> Receive Worker Master</span>
              {/* </li> */}
              {/* </ul> */}
            </li>
            <li className="d-block">
              <ul className="voucher_details">
                <li className="d-block">
                  <span>
                    ...
                    <p>
                      {" "}
                      Invoice Number : <span>{printObj.invoicenumber}</span>
                    </p>
                    <p>
...
export const FunctionalComponentToPrint = React.forwardRef((props, ref) => {
  ...
  return <ReceiveWorkerMasterPrintCom ref={ref} printObj={props.printObj} />;
});
