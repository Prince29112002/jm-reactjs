...
export class ReceiveFromCromePrintComp extends React.PureComponent {
                ...
                <div className="" style={{ margin: 10 }}>
                    ...
                    <ul className="  ">
                        <li className="voucher_heading">
                            ...
                            <span>chrome Receive From Worker</span>
                            {/* </li> */}
                            {/* </ul> */}
                        </li>
                        <li className="d-block">
...
export const FunctionalComponentToPrint = React.forwardRef((props, ref) => {
    ...
    return <ReceiveFromCromePrintComp ref={ref} printObj={props.printObj} />;
});
