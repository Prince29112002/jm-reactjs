...
export class SilverRepairingPrintComp extends React.PureComponent {
...
export const FunctionalComponentToPrint = React.forwardRef((props, ref) => {
    ...
    return <SilverRepairingPrintComp ref={ref} printObj={props.printObj} />;
});
