...
export class SilverRejectionPrintComp extends React.PureComponent {
                ...
                <div className="" style={{ margin: 10 }}>
                    ...
                    <ul className="  ">
                        <li className="voucher_heading">
                            ...
                            <span>Silver Repairing Received</span>
                            {/* </li> */}
                            {/* </ul> */}
                        </li>
                        <li className="d-block">
...
export const FunctionalComponentToPrint = React.forwardRef((props, ref) => {
    ...
    return <SilverRejectionPrintComp ref={ref} printObj={props.printObj} />;
});
