...
const RawMaterialPurchase = (props) => {
  ...
  useEffect(() => {
    // getRawMaterialpurchases("api/rawMaterialPurchase");
    getVendordata();
  ...
  function setFilters() {
    let url = "api/rawMaterialPurchase?"
  ...
  function viewHandler(id) {
    props.history.push("/dashboard/sales/addrawmaterialpurchase", {
      id: id,
    });
  }
  ...
  function callDeleteRawMaterialPurchaseApi() {
    if (validateDelete()) {
      const body = {
      ...
      axios
        ...
        .catch((error) => {
          handleError(error, dispatch, {
            api: "api/rawMaterialPurchase/" + selectedIdForDelete,
            body,
          });
        });
      handleClose();
        ...
        <div className="flex flex-col md:flex-row container">
          ...
          >
            ...
            >
              ...
              >
                <Link
                  to="/dashboard/sales/addrawmaterialpurchase"
            ...
            <div className="main-div-alll" style={{ marginTop: "20px" }}>
              ...
              <div className="mt-20 department-tbl-mt-dv repairedissue-table">
                ...
                <Paper
                  className={clsx(
                    classes.tabroot,
                    "new-add_stock_group_tbel table-responsive rowmaterialpurchase-tabel rowmaterialpurchase-tabel-dv"
                  )}
                >
            ...
            >
              ...
              <DialogActions>
                ...
                <Button
                  onClick={callDeleteRawMaterialPurchaseApi}
