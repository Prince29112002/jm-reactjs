...
export class RawMaterialPurPrintComp extends React.PureComponent {
  // constructor(props) {
  //   super(props);
  ...
  render() {
    ...
    console.log(printObj, "print", isView);
    ...
    const siteSetData = localStorage.getItem("siteSetting")
      ...
      console.log("this is admin signature")
          ...
          <ul className="jewellery_main_print_dv ">
            ...
            <li className="d-block">
              <ul className="jewellery_print_secand">
                <li className="d-block">
                  <h1>Raw Material Purchase Voucher</h1>
                </li>
              </ul>
            </li>
            <li className="d-block">
...
export const FunctionalComponentToPrint = React.forwardRef((props, ref) => {
  ...
  return <RawMaterialPurPrintComp ref={ref} printObj={props.printObj} />;
});
