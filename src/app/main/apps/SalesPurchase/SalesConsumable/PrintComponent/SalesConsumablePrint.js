...
export class SalesConsumablePrint extends React.PureComponent {
  // constructor(props) {
  //   super(props);
          ...
          <ul className="jewellery_main_print_dv ">
            ...
            <li className="d-block">
              <ul className="jewellery_print_secand">
                <li className="d-block">
                  <h1>Sales Consumable Voucher</h1>
                </li>
              </ul>
            </li>
            <li className="d-block">
...
export const FunctionalComponentToPrint = React.forwardRef((props, ref) => {
  ...
  return <SalesConsumablePrint ref={ref} printObj={props.printObj} />;
});
