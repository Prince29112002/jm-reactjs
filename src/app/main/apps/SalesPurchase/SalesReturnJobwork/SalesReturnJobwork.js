...
const SalesReturnJobwork = (props) => {
  ...
  function setFilters() {
    ...
    if (selectedVendor !== "") {
      if (client) {
        ...
        var isVendor = 1;
        url =
          url + "&clientCompany=" + venClient + "&is_vendor_client=" + isVendor;
      }
    }
  ...
  function deleteHandler(id) {
    ...
    function viewHandler(id) {
      props.history.push("/dashboard/sales/addsalesreturnjobwork", {
        id: id,
      });
    }
  ...
  function callDeleteRepairRecFromCust() {
    if (validateDelete()) {
      ...
      axios
        ...
        .catch((error) => {
          handleError(error, dispatch, {
            api: "api/salesJobworkReturn/" + selectedIdForDelete,
            body,
          });
        });
      handleClose();
        ...
        <div className="flex flex-col md:flex-row container">
          <div className="flex flex-1 flex-col min-w-0 makeStyles-root-1" style={{marginTop: "30px"}}>
            ...
            >
              ...
              >
                <Link
                  to="/dashboard/sales/addsalesreturnjobwork"
            ...
            <div className="main-div-alll" style={{marginTop: "20px"}}>
              ...
              <div className="mt-20 department-tbl-mt-dv salesrejobwork-tbl">
                  ...
                  <Table className={classes.table}>
                    <TableHead>
                      <TableRow>
                        ...
                        <TableCell className={classes.tableRowPad}  style={{textAlign:"center", display:"flow"}} >
                          Total Fine
                        </TableCell>
                        <TableCell className={classes.tableRowPad} align="left">
                          Amount
                    ...
                    <TableBody>
                      {apiData.length === 0 ? (<>
                      <TableRow>
                        <TableCell className={classes.tableRowPad} colSpan={8}  style={{justifyContent: "center", textAlign:"center"}}>
                          No Data
                        </TableCell>
                      </TableRow>
                      </>) : apiData
                        ...
                        .map((row) => (
                          <TableRow key={row.id}>
                            ...
                            <TableCell
                              // align="left"
                              style={{textAlign:"center", display:"flow"}}
                              className={classes.tableRowPad}
                            >
...
export default SalesReturnJobwork;
