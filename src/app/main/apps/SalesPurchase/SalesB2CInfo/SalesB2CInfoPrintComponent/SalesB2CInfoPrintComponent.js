...
export class AddSalesB2CInfoPrintComponent extends React.PureComponent {
  ...
  render() {
    ...
    console.log(printObj.voucherDate);
...
export const FunctionalComponentToPrint = React.forwardRef((props, ref) => {
  ...
  return <AddSalesB2CInfoPrintComponent ref={ref} printObj={props.printObj} />;
});
