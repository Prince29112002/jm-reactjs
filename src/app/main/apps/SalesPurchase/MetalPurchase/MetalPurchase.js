...
const MetalPurchase = (props) => {
  ...
  // useEffect(() => {
  //   let arr = roleOfUser
  //       ? roleOfUser["Sales Purchase"]["Metal Purchase"]
  //         ? roleOfUser["Sales Purchase"]["Metal Purchase"]
  //         : []
  //       : [];
  //   const arrData = [];
  ...
  useEffect(() => {
    // console.log("useEffect",selectedDepartment);
  ...
  function resetFilters() {
    ...
    getMetalpurchases("api/metalpurchase?");
  }
  ...
  function viewHandler(id) {
    props.history.push("/dashboard/sales/addmetalpurchase", {
      id: id
    });
  }
  ...
  function callDeleteMetalPurchaseApi() {
    if(validateDelete()){
      ...
      axios
      .post(Config.getCommonUrl() + "api/metalpurchase/" + selectedIdForDelete ,body)
      .then(function (response) {
        console.log(response);
        if (response.data.success === true) {
          dispatch(Actions.showMessage({ message: response.data.message }));
      ...
      .catch((error) => {
        handleError(error, dispatch, {api : "api/metalpurchase/" + selectedIdForDelete, body:body})
      });
      handleClose()
    }
  }
        ...
        <div className="flex flex-col md:flex-row container">
          <div className="flex flex-1 flex-col min-w-0 makeStyles-root-1" style={{marginTop: "30px"}}>
            ...
            >
              ...
              >
                <Link
                  to="/dashboard/sales/addmetalpurchase"
            ...
            <div className="main-div-alll" style={{marginTop: "20px"}}>
              ...
              <div className="mt-20 department-tbl-mt-dv repairedissue-table metalpurchase-tbl-blg ">
