...
export class JewellaryPurReturnPrintComp extends React.PureComponent {
  // constructor(props) {
  //   super(props);
...
export const FunctionalComponentToPrint = React.forwardRef((props, ref) => {
  ...
  return <JewellaryPurReturnPrintComp ref={ref} printObj={props.printObj} />;
});
