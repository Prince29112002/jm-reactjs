...
const ConsumablePurchase = (props) => {
  ...
  function setFilters() {
    ...
    //   return;
    // }
    let url = "api/consumablepurchase?";
  ...
  function viewHandler(id) {
    ...
    props.history.push("/dashboard/sales/addconsumablepurchase", {
      id: id
    });
  }
  ...
  function callDeleteConsumablePurchaseApi() {
    if(validateDelete()){
      ...
      axios
      .post(
        Config.getCommonUrl() + "api/consumablepurchase/" + selectedIdForDelete , body
      )
      .then(function (response) {
        console.log(response);
        if (response.data.success === true) {
      ...
      .catch((error) => {
        handleError(error, dispatch, {api : "api/consumablepurchase/" + selectedIdForDelete , body})
      });
      handleClose()
    }
  }
        ...
        <div className="flex flex-col md:flex-row container">
          <div className="flex flex-1 flex-col min-w-0  makeStyles-root-1" style={{marginTop: "30px"}}>
            ...
            >
              ...
              >
                <Link
                  to="/dashboard/sales/addconsumablepurchase"
...
export default ConsumablePurchase;
