...
const SalesJobwork = (props) => {
    ...
    // useEffect(() => {
    //   let arr = roleOfUser
    //       ? roleOfUser["Sales Purchase"]["Sales Job Work"]
    //         ? roleOfUser["Sales Purchase"]["Sales Job Work"]
    //         : []
    //       : [];
    //   const arrData = [];
    ...
    function callDeleteRepairRecFromCust() {
      if(validateDelete()){
        ...
        axios
        .post(
          Config.getCommonUrl() + "api/salesJobwork/" + selectedIdForDelete , body
        )
        .then(function (response) {
          console.log(response);
          if (response.data.success === true) {
        ...
        .catch((error) => {
          handleError(error, dispatch, {api : "api/salesJobwork/" + selectedIdForDelete, body})
        });
        handleClose()
      }
    }
        ...
        <div className="flex flex-col md:flex-row container">
          ...
          style={{ marginTop: "30px" }}>
            ...
            >
              ...
              >
                <Link
                  to="/dashboard/sales/addsalejobwork"
            ...
            <div className="main-div-alll" style={{ marginTop: "20px" }}>
              ...
              >
                <Grid
                  ...
                  xs={12}
                >
                  <p style={{ paddingBottom: "5px" }}>Select Party</p>
                  <Select
                ...
                <Grid item lg={2} md={4} sm={6} xs={12}>
                  <p style={{ paddingBottom: "5px" }}>Select firm</p>
                  <Select
                    filterOption={createFilter({ ignoreAccents: false })}
                    classes={classes}
                    styles={selectStyles}
