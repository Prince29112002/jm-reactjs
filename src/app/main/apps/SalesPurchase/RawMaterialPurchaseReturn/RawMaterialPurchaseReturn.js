...
const RawMaterialPurchaseReturn = (props) => {
  ...
  useEffect(() => {
    ...
    // getRawMaterialpurchases("api/rawMaterialPurchasereturn");
    getVendordata();
  ...
  function getRawMaterialpurchases(url) {
    setLoading(true);
    axios
  ...
  function setFilters() {
    ...
    //   return;
    // }
    let selectedDept = selectedDepartment.value.includes("-") ? selectedDepartment.value.split("-")[1] : selectedDepartment.value
    let url = "api/rawMaterialPurchasereturn?";
  ...
  function viewHandler(id) {
    props.history.push("/dashboard/sales/addrawmaterialpurchasereturn", {
      id: id,
    });
  }
  ...
  function callDeleteRawMatPurchaseApi() {
    if(validateDelete()){
      const body = {
        ...
        <div className="flex flex-col md:flex-row container">
          ...
          >
            ...
            >
              ...
              >
                <Link
                  to="/dashboard/sales/addrawmaterialpurchasereturn"
            ...
            <div className="main-div-alll" style={{ marginTop: "20px" }}>
              ...
              <div className=" mt-20 department-tbl-mt-dv repairedissue-table ">
                ...
                <Paper
                  className={clsx(
                    classes.tabroot,
                    "table-responsive rawmaterialpurchaseRe-dv raw_materialpurchas_return add_raw_materialpurchas_return"
                  )}
                >
                  <Table className={classes.table}>
                    ...
                    <TableBody>
                      {apiData.length === 0 ? (<>
                      <TableRow>
                        <TableCell className={classes.tableRowPad} colSpan={7} style={{textAlign:"center"}}>
                          No Data
                        </TableCell>
                      </TableRow>
                      </>) : apiData
                        ...
                        .map((row) => (
                          ...
                          <TableCell
                            ...
                            className={classes.tableRowPad}
                          >
                            {row.is_vendor_client === 1 ? row.Vendor.name : row.ClientCompany.client.name}
                          ...
                          <TableCell
                            ...
                            className={classes.tableRowPad}
                          >
                            {row.is_vendor_client === 1 ? row.Vendor.firm_name : row.ClientCompany.firm_name}
            ...
            >
              ...
              <DialogActions>
                ...
                <Button
                  onClick={callDeleteRawMatPurchaseApi}
                  className="delete-dialog-box-cancle-button"
                  autoFocus
                >
                  Delete
...
export default RawMaterialPurchaseReturn;
