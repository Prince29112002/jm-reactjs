...
const StockArticianReturnMetal = (props) => {
  ...
  // useEffect(() => {
  //   let arr = roleOfUser
  //       ? roleOfUser["Sales Purchase"]["Artician Return Metal"]
  //         ? roleOfUser["Sales Purchase"]["Artician Return Metal"]
  //         : []
  //       : [];
  //   const arrData = [];
  ...
  useEffect(() => {
    ...
    // getArticianReturnIR("api/jobworkarticianreturn");
    getJobworkerdata();
    //eslint-disable-next-line
  }, [dispatch]);
  ...
  function setFilters() {
    ...
    //   return;
    // }
    let url = "api/stockJVjobworkarticianreturn/jv?department_id=" + selectedDepartment.value.split("-")[1];
  ...
  function resetFilters() {
    ...
    getArticianReturnIR("api/stockJVjobworkarticianreturn/jv?department_id=" + selectedDepartment.value.split("-")[1]);
  }
  ...
  function viewHandler(id) {
    ...
    props.history.push("/dashboard/sales/stockarticianreturnmrtal/addstockarticianreturnmetal", {
      id: id
    });
  }
  ...
  function callDeleteArticianReturnApi() {
    if(validateDelete()){
      ...
      .post(
        Config.getCommonUrl() +
        "api/stockJVjobworkarticianreturn/jv/" +
      ...
      .catch((error) => {
        handleError(error, dispatch, {api : "api/stockJVjobworkarticianreturn/jv/" +
        selectedIdForDelete , body})
      });
      handleClose()
    }
        ...
        <div className="flex flex-col md:flex-row container">
          <div className="flex flex-1 flex-col min-w-0" style={{ marginTop: "30px" }}>
            ...
            >
              <Grid item xs={12} sm={6} md={6} key="1">
                <FuseAnimate delay={300}>
                  ...
                  Artician Return Metal (Stock Journal Voucher)
                  </Typography>
                </FuseAnimate>
              </Grid>
              <Grid
              ...
              >
                <Link
                  to="/dashboard/sales/stockarticianreturnmrtal/addstockarticianreturnmetal"
            ...
            <div className="mt-16 department-tbl-mt-dv">
              ...
              <Paper className={clsx(classes.tabroot, "table-responsive articianreturnIR-dv view_articianreturnIR-dv")}>
                      ...
                      .map((row) => (
                        <TableRow key={row.id}>
                          ...
                          <TableCell
                            ...
                            className={classes.tableRowPad}
                          >
                            {row.stockJVJobWorker !== null &&
                              row.stockJVJobWorker.firm_name}
                          </TableCell>
                          <TableCell
                            align="left"
                            className={classes.tableRowPad}
...
export default StockArticianReturnMetal;
