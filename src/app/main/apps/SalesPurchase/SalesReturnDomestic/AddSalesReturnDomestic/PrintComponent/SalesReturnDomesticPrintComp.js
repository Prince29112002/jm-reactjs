...
export class SalesReturnDomesticPrintComp extends React.PureComponent {
  // constructor(props) {
  //   super(props);
          ...
          <ul className="jewellery_main_print_dv ">
            ...
            <li className="d-block">
              <ul className="jewellery_print_secand">
                <li className="d-block">
                  <h1>Sales Domestic Return Voucher</h1>
                </li>
              </ul>
            </li>
            <li className="d-block">
              ...
              <div className="tabel-deta-show">
                <div className="row">
                  <div className="header-tabel-deta">
                    ...
                    {(printObj.loadType === "2" ||
                      printObj.loadType === "3" ||
                      printObj.loadType === "4") && <div>HSN/SAC</div>}
                    <div>Purity</div>
                    <div>Gross Wt</div>
                    <div>Net Wt</div>
                    <div>Fine Wt</div>
...
export const FunctionalComponentToPrint = React.forwardRef((props, ref) => {
  ...
  return <SalesReturnDomesticPrintComp ref={ref} printObj={props.printObj} />;
});
