...
const SalesReturnDomestic = (props) => {
    ...
    function setFilters() {
      ...
      //   return;
      // }
      let url = "api/salesDomesticReturn?";
    ...
    function resetFilters() {
      ...
      getSalesDomestic("api/salesDomesticReturn?");
    }
    ...
    function viewHandler(id) {
      ...
      props.history.push("/dashboard/sales/addsalesreturndomestic", {
        id: id
      });
    }
    ...
    function callDeleteRepairRecFromCust() {
      if(validateDelete()){
        ...
        axios
        .post(
          Config.getCommonUrl() + "api/salesDomesticReturn/" + selectedIdForDelete , body
        )
        .then(function (response) {
          console.log(response);
          if (response.data.success === true) {
        ...
        .catch((error) => {
          handleError(error, dispatch, { api: "api/salesDomesticReturn/" + selectedIdForDelete , body})
        });
        handleClose()
      }
    }
        ...
        <div className="flex flex-col md:flex-row container">
          <div className="flex flex-1 flex-col min-w-0 makeStyles-root-1" style={{marginTop: "30px"}}>
            ...
            >
              ...
              >
                <Link
                  to="/dashboard/sales/addsalesreturndomestic"
...
export default SalesReturnDomestic;
