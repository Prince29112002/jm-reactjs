...
const ExportMetalPurchase = (props) => {
  ...
  function getExportMetalpurchases(url) {
    setLoading(true);
    axios
  ...
  function setFilters() {
    ...
    //   return;
    // }
    let url = "api/exportmetalpurchase?"
  ...
  function resetFilters() {
    ...
    getExportMetalpurchases("api/exportmetalpurchase?");
  }
  ...
  function viewHandler(id) {
    props.history.push("/dashboard/sales/addexportmetalpurchase", {
      id: id,
    });
  }
  ...
  function callDeleteEXPApi() {
    if(validateDelete()){
      ...
      axios
      .post(
        Config.getCommonUrl() + "api/exportmetalpurchase/" + selectedIdForDelete , body
      )
      .then(function (response) {
        console.log(response);
        if (response.data.success === true) {
      ...
      .catch((error) => {
        handleError(error, dispatch, {api : "api/exportmetalpurchase/" + selectedIdForDelete,body})
      });
      handleClose()
    }
  }
        ...
        <div className="flex flex-col md:flex-row container">
          <div className="flex flex-1 flex-col min-w-0  makeStyles-root-1" style={{marginTop: "30px"}}>
            ...
            >
              ...
              >
                <Link
                  to="/dashboard/sales/addexportmetalpurchase"
            ...
            <div className="main-div-alll" style={{marginTop: "20px"}}>
              ...
              <div className="mt-20 department-tbl-mt-dv repairedissue-table">
                ...
                <Paper
                  className={clsx(
                    classes.tabroot,
                    " new-add_stock_group_tbel table-responsive exportmetal-purchase-tabel exportmetal-purchase_dv"
                  )}
                >
...
export default ExportMetalPurchase;
