...
export class ExpMetalPurPrintComp extends React.PureComponent {
  // constructor(props) {
  //   super(props);
  // }
  // canvasEl;
  ...
  render() {
    ...
    console.log(printObj, "printObj", isView);
          ...
          <ul className="jewellery_main_print_dv ">
            ...
            <li className="d-block">
              <ul className="jewellery_print_secand">
                <li className="d-block">
                  <h1> Export Metal Purchase Voucher</h1>
                </li>
              </ul>
            </li>
            <li className="d-block">
                        ...
                        <div border="1" className=" alignment-right-text">
                          ...
                          {Config.numWithComma(
                            (printObj.iGstTot === "" ||
                              ...
                              printObj.sGstTot !== ""
                              ? printObj.sGstTot
                              : printObj.iGstTot !== "" && printObj.iGstTot
                          )}{" "}
                        </div>
                      </div>
...
export const FunctionalComponentToPrint = React.forwardRef((props, ref) => {
  ...
  return <ExpMetalPurPrintComp ref={ref} printObj={props.printObj} />;
});
