...
const ArticianIssueIR = (props) => {
   ...
   function setFilters() {
     ...
     //   return;
     // }
     let url = "api/jobworkarticianissue?";
   ...
   function viewHandler(id) {
     ...
     props.history.push("/dashboard/sales/addarticianissue", {
       id: id
     });
   }
   ...
   function callDeleteJobWorkMetalRecApi() {
     if(validateDelete()){
       ...
       axios
       .post(
         Config.getCommonUrl() + "api/jobworkarticianissue/" + selectedIdForDelete , body
       )
       .then(function (response) {
         console.log(response);
         if (response.data.success === true) {
       ...
       .catch((error) => {
         handleError(error, dispatch, {api : "api/jobworkarticianissue/" + selectedIdForDelete,body})
       });
       handleClose()
     }
   }
        ...
        <div className="flex flex-col md:flex-row container">
          <div className="flex flex-1 flex-col min-w-0 makeStyles-root-1" style={{ marginTop: "30px" }}>
            ...
            >
              ...
              >
                <Link
                  to="/dashboard/sales/addarticianissue"
            ...
            <div className="main-div-alll" style={{ marginTop: "20px" }}>
              ...
              <div className="mt-16 department-tbl-mt-dv">
                ...
                <Paper
                  className={clsx(
                    classes.tabroot,
                    "table-responsive articianissueIR-dv articianissueIR_tabel-dv"
                  )}
                >
...
export default ArticianIssueIR;
