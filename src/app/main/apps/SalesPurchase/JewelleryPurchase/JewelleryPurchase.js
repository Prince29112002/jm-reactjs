...
const JewelleryPurchase = (props) => {
  ...
  function resetFilters() {
    ...
    getJewellarypurchases("api/jewellerypurchase?")
  }
  ...
  function viewHandler(id) {
    ...
    props.history.push("/dashboard/sales/addjewellerypurchase", {
      id: id
    });
  }
  ...
  function callDeleteJewellaryPurchaseApi() {
    if(validateDelete()){
      ...
      axios
      .post(
        Config.getCommonUrl() + "api/jewellerypurchase/" + selectedIdForDelete , body
      )
      .then(function (response) {
        console.log(response);
        if (response.data.success === true) {
      ...
      .catch((error) => {
        handleError(error, dispatch, {api : "api/jewellerypurchase/" + selectedIdForDelete,body})
      });
      handleClose()
    }
  }
        ...
        <div className="flex flex-col md:flex-row container">
          <div className="flex flex-1 flex-col min-w-0 makeStyles-root-1" style={{marginTop: "30px"}}>
            ...
            >
              ...
              >
                <Link
                  to="/dashboard/sales/addjewellerypurchase"
...
export default JewelleryPurchase;
