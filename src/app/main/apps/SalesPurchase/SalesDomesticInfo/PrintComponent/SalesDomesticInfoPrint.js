...
export class SalesDomesticInfoPrint extends React.PureComponent {
  // constructor(props) {
  //     super(props);
  ...
  render() {
    ...
    console.log(printObj, isView, getDateAndTime);
          ...
          <ul className="jewellery_main_print_dv">
            ...
            <li className="d-block">
              <ul className="jewellery_print_secand">
                <li className="d-block">
                  <h1>Sales Domestic Voucher Info</h1>
                </li>
              </ul>
            </li>
            <li className="d-block">
...
export const FunctionalComponentToPrint = React.forwardRef((props, ref) => {
  ...
  return <SalesDomesticInfoPrint ref={ref} printObj={props.printObj} />;
});
