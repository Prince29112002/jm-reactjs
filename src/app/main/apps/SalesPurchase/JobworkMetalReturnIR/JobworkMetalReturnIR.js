...
const JobworkMetalReturnIR = (props) => {
...
//  }, [])
 ...
 useEffect(() => {
   // getJobWorkMetalRetrunIR("api/jobworkmetalreturn");
   getClientData();
 ...
 function getJobWorkMetalRetrunIR(url) {
   setLoading(true);
   axios
 ...
 function setFilters() {
   ...
   //   return;
   // }
   let url = "api/jobworkmetalreturn?";
   ...
   if (selectedCompany !== "") {
     if (selectedClient !== "") {
       ...
       url = url + "&client_company_id=" + selectedCompany.value;
     } else {
       url = url + "&client_company_id=" + selectedCompany.value;
     }
   }
 ...
 function viewHandler(id) {
   ...
   props.history.push("/dashboard/sales/addjobworkmetalreturn", {
     id: id
   });
 }
 ...
 function callDeletejobWorkMetalReturn() {
   if(validateDelete()){
     const body = {
     ...
     axios
     .post(
       Config.getCommonUrl() + "api/jobworkmetalreturn/" + selectedIdForDelete , body
     )
     .then(function (response) {
       console.log(response);
       if (response.data.success === true) {
     ...
     .catch((error) => {
       handleError(error, dispatch, {api : "api/jobworkmetalreturn/" + selectedIdForDelete , body})
     });
     handleClose()
   }
 }
        ...
        <div className="flex flex-col md:flex-row container">
          ...
          >
            ...
            >
              ...
              >
                <Link
                  to="/dashboard/sales/addjobworkmetalreturn"
            ...
            <div className="main-div-alll" style={{ marginTop: "20px" }}>
              ...
              <div className="mt-20 department-tbl-mt-dv">
                ...
                <Paper
                  className={clsx(
                    classes.tabroot,
                    "table-responsive jobwork_metalreturn-dv jobwork_tbl_metalreturn-dv"
                  )}
                >
                  <Table className={classes.table}>
                    <TableHead>
                      <TableRow>
                        ...
                        <TableCell className={classes.tableRowPad} align="left" style={{width:"20%"}}>
                          Firm Name
                        </TableCell>
                        <TableCell className={classes.tableRowPad} align="left">
                          Total Fine
            ...
            >
              ...
              <DialogActions>
                ...
                <Button
                  onClick={callDeletejobWorkMetalReturn}
...
export default JobworkMetalReturnIR;
