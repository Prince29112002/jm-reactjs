...
export class AddJobworkMetalReturnIRPrint extends React.PureComponent {
  componentDidMount() {}
          ...
          <ul className="jewellery_main_print_dv ">
            ...
            <li className="d-block">
              <ul className="jewellery_print_secand">
                <li className="d-block">
                  <h1>Jobwork Metal Return Voucher</h1>
                </li>
              </ul>
            </li>
            <li className="d-block">
              ...
              <div className="tabel-deta-show">
                ...
                <div className="row">
                  ...
                  <div className="body-tabel-deta body-tabel-deta-bdr">
                    ...
                    {printObj.stateId === 12 ? (
                      <div border="1" className="text-left-dv-blg"></div>
                    ) : (
                      <div border="1" className="text-left-dv-blg"></div>
                    )}
                    <div border="1" className=" alignment-right-text">
                  ...
                  {printObj.stateId === 12 && (
                    <div className="body-tabel-deta body-tabel-deta-bdr">
                      ...
                      <div className="text-left-dv-blg"></div>
...
export const FunctionalComponentToPrint = React.forwardRef((props, ref) => {
  ...
  return <AddJobworkMetalReturnIRPrint ref={ref} printObj={props.printObj} />;
});
