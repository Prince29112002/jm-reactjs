...
export class RepairedlssToJobWorkerPrintComp extends React.PureComponent {
  // constructor(props) {
  //   super(props);
          ...
          <ul className="jewellery_main_print_dv ">
            ...
            <li className="d-block">
              <ul className="jewellery_print_secand">
                <li className="d-block">
                  <h1> Repairing issued to job worker voucher</h1>
                </li>
              </ul>
            </li>
            <li className="d-block">
              ...
              <div className="tabel-deta-show tabel-deta-show_total totallast_col">
                <div className="row">
                  <div className="body-tabel-deta">
                    ...
                    <div>{printObj.jobWorkFineinPure}</div>
                    <div className="text-left-dv-blg">
                      <b>Total Inv. Amt. </b>
                    </div>
                    <div className=" alignment-right-text">
                      {" "}
                      {Config.numWithComma(printObj.totalValution)}{" "}
                    </div>
                  </div>
                </div>
              </div>
...
export const FunctionalComponentToPrint = React.forwardRef((props, ref) => {
  ...
  return (
    <RepairedlssToJobWorkerPrintComp ref={ref} printObj={props.printObj} />
  );
});
