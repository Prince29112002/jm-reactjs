...
const RepairedIssToJobWor = (props) => {
  ...
  useEffect(() => {
    // getRepairingIssuedToJobworker("api/repairingIssuedToJobworker");
    getJobworkerdata();
  ...
  function getRepairingIssuedToJobworker(url) {
    setLoading(true);
    axios
  ...
  function setFilters() {
    ...
    //   return;
    // }
    let url = "api/repairingIssuedToJobworker?";
    ...
    console.log(url);
    getRepairingIssuedToJobworker(url);
  }
  ...
  function viewHandler(id) {
    props.history.push("/dashboard/sales/addrepairedisstojobwor", {
      id: id,
    });
  }
  ...
  function callDeleteRepairingIssuedToJobworker() {
    if (validateDelete()) {
      const body = {
      ...
      axios
        .post(
          Config.getCommonUrl() +
            "api/repairingIssuedToJobworker/" +
            selectedIdForDelete,
          body
        )
        .then(function (response) {
        ...
        .catch((error) => {
          handleError(error, dispatch, {
            api: "api/repairingIssuedToJobworker/" + selectedIdForDelete,
            body,
          });
        });
      handleClose();
        ...
        <div className="flex flex-col md:flex-row container">
          ...
          >
            ...
            >
              <Grid item xs={9} sm={9} md={8} key="1">
                <FuseAnimate delay={300}>
                  <Typography className="text-18 font-700">
                    Repairing Issued to the Jobworker
                  </Typography>
                </FuseAnimate>
              ...
              >
                <Link
                  to="/dashboard/sales/addrepairedisstojobwor"
            ...
            <div className="main-div-alll" style={{ marginTop: "20px" }}>
              ...
              <Grid container spacing={2} alignItems="center">
                ...
                <Grid item lg={2} md={4} sm={12} xs={12}>
                  <p style={{ paddingBottom: "5px" }}>Jobworker name</p>
                  <Select
              ...
              <div className="mt-20 department-tbl-mt-dv repairedissue-table">
                ...
                <Paper
                  className={clsx(
                    classes.tableheader,
                    "table-responsive repairedissuejobwork-table repairedissuejobwork-table-blg view_repairedissuejobwork-table-blg"
                  )}
                >
            ...
            >
              ...
              <DialogActions>
                ...
                <Button
                  onClick={callDeleteRepairingIssuedToJobworker}
...
export default RepairedIssToJobWor;
