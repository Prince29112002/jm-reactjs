...
const JewelPurchaseArticianReturn = (props) => {
  ...
  useEffect(() => {
    ...
    // getJewelpurchasesArtician("api/jewelleryPurchaseArticianReturn");
    getJobworkerdata();
  ...
  function setFilters() {
    ...
    //   return;
    // }
    let url = "api/jewelleryPurchaseArticianReturn?";
  ...
  function viewHandler(id) {
    props.history.push("/dashboard/sales/addarticianjewellerypurchasereturn", {
      id: id,
    });
  }
  ...
  function callDeleteJewellaryPurchaseApi() {
    if (validateDelete()) {
      ...
      axios
        .post(
          Config.getCommonUrl() +
            "api/jewelleryPurchaseArticianReturn/" +
            selectedIdForDelete,
          body
        )
        .then(function (response) {
        ...
        .catch((error) => {
          handleError(error, dispatch, {
            api: "api/jewelleryPurchaseArticianReturn/" + selectedIdForDelete,
            body,
          });
        });
      handleClose();
        ...
        <div className="flex flex-col md:flex-row container">
          <div className="flex flex-1 flex-col min-w-0  makeStyles-root-1" style={{ marginTop: "30px" }}>
            ...
            >
              ...
              >
                <Link
                  to="/dashboard/sales/addarticianjewellerypurchasereturn"
            ...
            <div className="main-div-alll" style={{ marginTop: "20px" }}>
              ...
              <div className="mt-20 department-tbl-mt-dv repairedissue-table">
                ...
                <Paper
                  className={clsx(
                    classes.tabroot,
                    "table-responsive jewelleryreturnpurchaseatician-tabel add_jewelleryreturnpurchaseatician-tabel"
                  )}
                >
...
export default JewelPurchaseArticianReturn;
