...
export class MetalPurReturnPrintComp extends React.PureComponent {
  // constructor(props) {
  //   super(props);
  ...
  render() {
    ...
    console.log(printObj, "1111", isView);
          ...
          <ul className="jewellery_main_print_dv ">
            ...
            <li className="d-block">
              <ul className="jewellery_print_secand">
                <li className="d-block">
                  <h1>Metal Purchase Return Voucher</h1>
                </li>
              </ul>
            </li>
            <li className="d-block">
                ...
                <div className="row">
                  <div className="body-tabel-deta">
                    <div className="flex_balancep_payable">
                      ...
                      <span className="EOE_alignment print-div-left-increase">
                        {" "}
                        E. & O.E
                      </span>
                    </div>
            ...
            {(printObj.is_tds_tcs == "1" || printObj.is_tds_tcs == "2") && (
              <li className="d-block">
                <div className="tabel-deta-show tabel-deta-show_total">
                  <div className="row">
                    <div className="body-tabel-deta">
                      {/* <div>Tax Amount (in words) :   <span> {printObj.taxableAmount !== "" && toWords.convert(Math.round(printObj.taxableAmount))} */}
...
export const FunctionalComponentToPrint = React.forwardRef((props, ref) => {
  ...
  return <MetalPurReturnPrintComp ref={ref} printObj={props.printObj} />;
});
