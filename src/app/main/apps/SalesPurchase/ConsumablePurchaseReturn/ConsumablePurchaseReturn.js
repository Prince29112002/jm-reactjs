...
const ConsumablePurchaseReturn = (props) => {
  ...
  useEffect(() => {
    ...
    // getConsumablePurchases("api/consumablepurchasereturn");
    getVendordata();
  ...
  function setFilters() {
    ...
    //   return;
    // }
    let url = "api/consumablepurchasereturn?";
  ...
  function viewHandler(id) {
    props.history.push("/dashboard/sales/addconsumablepurchasereturn", {
      id: id,
    });
  }
  ...
  function callDeleteConsumablePurchaseApi() {
    if(validateDelete()){
      ...
      axios
      .post(
        Config.getCommonUrl() + "api/consumablepurchasereturn/" + selectedIdForDelete , body
      )
      .then(function (response) {
        console.log(response);
        if (response.data.success === true) {
      ...
      .catch((error) => {
        handleError(error, dispatch, { api: "api/consumablepurchasereturn/" + selectedIdForDelete , body})
      });
      handleClose()
    }
  }
        ...
        <div className="flex flex-col md:flex-row container">
          <div className="flex flex-1 flex-col min-w-0 makeStyles-root-1"  style={{ marginTop: "30px" }}>
            ...
            >
              ...
              >
                <Link
                  to="/dashboard/sales/addconsumablepurchasereturn"
            ...
            <Grid item lg={3} md={4} sm={6} xs={12}>
              ...
              <div className="mt-20 department-tbl-mt-dv repairedissue-table">
                ...
                <Paper
                  className={clsx(
                    classes.tabroot,
                    "table-responsive consumablepurchase-return-div addconsumablepurchase-blg consumablepurchase-return-blg"
                  )}
                >
...
export default ConsumablePurchaseReturn;
