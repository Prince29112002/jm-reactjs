...
const JobworkMetalReceiveIR = (props) => {
  ...
  useEffect(() => {
    // getJobWorkMetalRecIR("api/jobworkmetalreceive");
    getClientData();
  ...
  function getJobWorkMetalRecIR(url) {
    setLoading(true);
    axios
  ...
  function setFilters() {
    ...
    let url = "api/jobworkmetalreceive?";
  ...
  function viewHandler(id) {
    ...
    props.history.push("/dashboard/sales/addjobworkmetalreceive", {
      id: id
    });
  }
  ...
  function callDeleteJobWorkMetalRecApi() {
    if(validateDelete()){
      ...
      axios
      .post(
        Config.getCommonUrl() + "api/jobworkmetalreceive/" + selectedIdForDelete , body
      )
      .then(function (response) {
        console.log(response);
        if (response.data.success === true) {
      ...
      .catch((error) => {
        handleError(error, dispatch, { api: "api/jobworkmetalreceive/" + selectedIdForDelete  , body})
      }); 
      handleClose()
    }
  }
        ...
        <div className="flex flex-col md:flex-row container">
          <div className="flex flex-1 flex-col min-w-0 makeStyles-root-1" style={{ marginTop: "30px" }}>
            ...
            >
              ...
              >
                <Link
                  to="/dashboard/sales/addjobworkmetalreceive"
            ...
            <div className="main-div-alll" style={{ marginTop: "20px" }}>
              ...
              <div className=" mt-20 department-tbl-mt-dv ">
                ...
                <Paper
                  className={clsx(
                    classes.tabroot,
                    "table-responsive jobwork_metalrecevieir-dv jobwork_metalrecevieir-dv_tbl main-jobwork_metalrecevieir"
                  )}
                >
...
export default JobworkMetalReceiveIR;
