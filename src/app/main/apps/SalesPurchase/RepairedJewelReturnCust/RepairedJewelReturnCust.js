...
const RepairedJewelReturnCust = (props) => {
  ...
  useEffect(() => {
    ...
    // getRepairedRetToCust("api/repairingreturnedtoCustomer");
    getClientData();
  ...
  function getRepairedRetToCust(url) {
    setLoading(true);
    axios
  ...
  function setFilters() {
    ...
    //   return;
    // }
    let url = "api/repairingreturnedtoCustomer?";
  ...
  function callDeleteRepairedRetToCust() {
    if (validateDelete()) {
      const body = {
      ...
      axios
        .post(
          Config.getCommonUrl() +
            "api/repairingreturnedtoCustomer/" +
            selectedIdForDelete,
          body
        )
        .then(function (response) {
        ...
        .catch((error) => {
          handleError(error, dispatch, {
            api: "api/repairingreturnedtoCustomer/" + selectedIdForDelete,
            body,
          });
        });
      handleClose();
        ...
        <div className="flex flex-col md:flex-row container">
          ...
          >
            ...
            >
              ...
              >
                <Link
                  to="/dashboard/sales/addrepairedjewelreturncust"
            ...
            <div className="main-div-alll" style={{ marginTop: "20px" }}>
              ...
              <div className="mt-20 department-tbl-mt-dv">
                ...
                <Paper
                  className={clsx(
                    classes.tabroot,
                    "table-responsive repaired_jewelReturnCust-main-dv view_repaired_jewelReturnCust-main-dv "
                  )}
                >
            ...
            >
              ...
              <DialogActions>
                ...
                <Button
                  onClick={callDeleteRepairedRetToCust}
...
export default RepairedJewelReturnCust;
