      ...
      <MaUTable className={classes.table}>
        ...
        <TableBody>
          ...
          <TableRow style={{backgroundColor:"#D1D8F5"}}>
            ...
            <TableCell className={classes.tableRowPad} style={{fontWeight:"700"}}>
              {/* Amount */}
              {Config.numWithComma(HelperFunc.getTotalOfField(packingSlipData, "amount"))}
            </TableCell>
            <TableCell className={classes.tableRowPad} style={{fontWeight:"700"}}>
              {/* Hallmark Charge */}
              {Config.numWithComma(HelperFunc.getTotalOfField(packingSlipData,"hallmark_charges_pcs"))}
            </TableCell>
            <TableCell className={classes.tableRowPad} style={{fontWeight:"700"}}>
              {/* Total Amt */}
              {Config.numWithComma(HelperFunc.getTotalOfField(packingSlipData, "totalAmount"))}
            </TableCell>
