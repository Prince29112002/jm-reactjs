...
export class SalesJobworkInfoprint extends React.PureComponent {
  // constructor(props) {
  //   super(props);
          ...
          <ul className="jewellery_main_print_dv ">
            ...
            <li className="d-block">
              <ul className="jewellery_print_secand">
                <li className="d-block">
                  <h1>Sales Jobwork Voucher Info</h1>
                </li>
              </ul>
            </li>
            <li className="d-block">
                      ...
                      <div>
                        ...
                        <span>
                          ...
                          {printObj.taxableAmount !== "" &&
                            ...
                            toWords.convert(Math.round(printObj.taxableAmount))}
...
export const FunctionalComponentToPrint = React.forwardRef((props, ref) => {
  ...
  return <SalesJobworkInfoprint ref={ref} printObj={props.printObj} />;
});
