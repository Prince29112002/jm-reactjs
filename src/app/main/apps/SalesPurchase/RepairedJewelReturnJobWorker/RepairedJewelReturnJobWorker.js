...
const RepairedJewelReturnJobWorker = (props) => {
  ...
  useEffect(() => {
    ...
    // getRepairingReturnFromJobworker("api/repairingReturnFromJobWorker");
    getJobworkerdata();
  ...
  function getRepairingReturnFromJobworker(url) {
    setLoading(true);
    axios
  ...
  function setFilters() {
    ...
    //   return;
    // }
    let url = "api/repairingReturnFromJobWorker?";
    ...
    console.log(url);
    getRepairingReturnFromJobworker(url);
  }
  ...
  function viewHandler(id) {
    props.history.push("/dashboard/sales/addrepairedjewelreturnjobwork", {
      id: id,
    });
  }
  ...
  function callDeleteRepairingReturnJobworker() {
    if (validateDelete()) {
      const body = {
      ...
      axios
        .post(
          Config.getCommonUrl() +
            "api/repairingReturnFromJobWorker/" +
            selectedIdForDelete,
          body
        )
        .then(function (response) {
        ...
        .catch((error) => {
          handleError(error, dispatch, {
            api: "api/repairingReturnFromJobWorker/" + selectedIdForDelete,
            body,
          });
        });
      handleClose();
        ...
        <div className="flex flex-col md:flex-row container">
          ...
          >
            ...
            >
              ...
              >
                <Link
                  to="/dashboard/sales/addrepairedjewelreturnjobwork"
            ...
            <div className="main-div-alll" style={{ marginTop: "20px" }}>
              ...
              <div className="mt-20 department-tbl-mt-dv repairedissue-table">
                ...
                <Paper
                  className={clsx(
                    classes.tabroot,
                    "table-responsive repairedrepairedissue-table repairedrepairedissue-table-dv"
                  )}
                >
            ...
            >
              ...
              <DialogActions>
                ...
                <Button
                  onClick={callDeleteRepairingReturnJobworker}
...
export default RepairedJewelReturnJobWorker;
