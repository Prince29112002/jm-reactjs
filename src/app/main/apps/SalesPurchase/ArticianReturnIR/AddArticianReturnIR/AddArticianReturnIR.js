...
const AddArticianReturnIR = (props) => {
  ...
  function getArticianReturnRecord(id) {
    ...
    if(props.forDeletedVoucher){
      api = `api/jobworkarticianreturn/${id}?deleted_at=1`
    }else {
      api = `api/jobworkarticianreturn/${id}`
    }
    axios
          ...
          if (response.data.hasOwnProperty("data")) {
            if (response.data.data !== null) {
              ...
              if (loadType === 0 || loadType === 1) {
                ...
                for (let item of finalData.JobWorkArticianReturnOrder) {
                  // console.log(item);
                  tempArray.push({
                    stockCode: {
              ...
              setPrintObj({
                ...
                supState: finalData.JobWorker.state_name.name ? finalData.JobWorker.state_name.name : finalData.JobWorker.state_name.name,
                ...
                placeOfSupply: finalData.JobWorker.state_name.name ? finalData.JobWorker.state_name.name : finalData.JobWorker.state_name.name,
                ...
                totalAmount: parseFloat(finalData.final_invoice_amount).toFixed(3),
  ...
  function getVoucherNumber() {
    axios
      .get(Config.getCommonUrl() + "api/jobworkarticianreturn/get/voucher")
      .then(function (response) {
        console.log(response);
      ...
      .catch(function (error) {
        handleError(error, dispatch, {
          api: "api/jobworkarticianreturn/get/voucher",
        });
      });
  }
  ...
  function addMetalPurchase(resetFlag, toBePrint) {
    ...
    console.log(body)
    axios
      .post(Config.getCommonUrl() + "api/jobworkarticianreturn", body)
      .then(function (response) {
        console.log(response);
  ...
  function getVouchers(jobworkerId) {
    ...
    axios
      .post(
        ...
        "api/jobWorkArticianIssue/jobworker/jobworker",
        data
      )
      .then(function (response) {
        console.log(response);
                  ...
                  <Table className={classes.table}>
                    ...
                    <TableRow>
                      ...
                      <TableRow>
                        ...
                        <TableCell className={classes.tableRowPad}>
                            <TextField name="type" onChange={handleSearchData} value={searchDatas.type}/>
                        </TableCell>  
                        <TableCell className={classes.tableRowPad}></TableCell>
                        <TableCell className={classes.tableRowPad}></TableCell> 
                      </TableRow>
                        ...
                        .map((row, index) => (
                            ...
                            >
                              <Checkbox
                                ...
                                checked={selectedVoucher === row.id ? true : false}
                              />
                            </TableCell>
...
export default AddArticianReturnIR;
