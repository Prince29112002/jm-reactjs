...
export class ArticianReturnPrintComp extends React.PureComponent {
  componentDidMount() {}
          ...
          <ul className="jewellery_main_print_dv artisan_issue_printformate ">
            ...
            <li className="d-block">
              <ul className="jewellery_print_secand">
                <li className="d-block">
                  <h1>Artician Return Cum Delivery Voucher</h1>
                </li>
              </ul>
            </li>
            <li className="d-block">
                  ...
                  {printObj.orderDetails
                    ...
                    .map((element, index) => (
                      <div className="body-tabel-deta" key={index}>
                        {/* <div border="1">{ printObj.loadType === "2" ?element.categoryName.label:element.categoryName} </div> */}
                        {printObj.loadType === "2" ? (
                          <div border="1" style={{ justifyContent: "center" }}>
                            {element.categoryName.label}
                          </div>
                        ) : (
                          <div border="1" style={{ justifyContent: "center" }}>
              ...
              <div className="tabel-deta-show tabel-deta-show_total">
                <div className="row">
                  <div className="body-tabel-deta">
                    ...
                    <div>&nbsp;</div>
                    <div>{Config.numWithComma(printObj.totalInvoiceAmt)}</div>
                      ...
                      <span className="print-div-left-increase">
                        ...
                        <span className="print-div-left-increase">
                          ...
                          {printObj.totalAmount !== "" &&
                            !isNaN(printObj.totalAmount) &&
                            toWords.convert(printObj.totalAmount)}
...
export const FunctionalComponentToPrint = React.forwardRef((props, ref) => {
  ...
  return <ArticianReturnPrintComp ref={ref} printObj={props.printObj} />;
});
