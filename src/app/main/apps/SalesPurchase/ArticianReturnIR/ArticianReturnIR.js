...
const ArticianReturnIR = (props) => {
  ...
  function setFilters() {
    ...
    //   return;
    // }
    let url = "api/jobworkarticianreturn?";
  ...
  function viewHandler(id) {
    props.history.push("/dashboard/sales/addarticianreturn", {
      id: id,
    });
  }
  ...
  function callDeleteArticianReturnApi() {
    if(validateDelete()){
      ...
      .catch((error) => {
        handleError(error, dispatch, {api : "api/jobworkarticianreturn/" +
        selectedIdForDelete , body})
      });
      handleClose()
    }
        ...
        <div className="flex flex-col md:flex-row container">
          <div className="flex flex-1 flex-col min-w-0 makeStyles-root-1" style={{ marginTop: "30px" }}>
            ...
            >
              ...
              >
                <Link
                  to="/dashboard/sales/addarticianreturn"
            ...
            <div className="main-div-alll" style={{ marginTop: "20px" }}>
              ...
              <div className="mt-16 department-tbl-mt-dv">
                ...
                <Paper
                  className={clsx(
                    classes.tabroot,
                    "table-responsive articianreturnIR-dv view_articianreturnIR-dv"
                  )}
                >
...
export default ArticianReturnIR;
