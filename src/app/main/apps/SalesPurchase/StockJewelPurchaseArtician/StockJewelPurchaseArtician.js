...
const StockJewelPurchaseArtician = (props) => {
  ...
  // useEffect(() => {
  //   let arr = roleOfUser
  //       ? roleOfUser["Sales Purchase"]["Jewellery Purchase (Artician Receive)"]
  //         ? roleOfUser["Sales Purchase"]["Jewellery Purchase (Artician Receive)"]
  //         : []
  //       : [];
  //   const arrData = [];
  ...
  function setFilters() {
    ...
    //   return;
    // }
    let url = "api/stockJVJewelleryPurchaseArtician?department_id=" + selectedDepartment.value.split("-")[1];
  ...
  function resetFilters() {
    ...
    getJewelpurchasesArtician("api/stockJVJewelleryPurchaseArtician?department_id=" + selectedDepartment.value.split("-")[1]);
  }
  ...
  function viewHandler(id) {
    ...
    props.history.push("/dashboard/sales/stockjewelpurchaseartician/addstockjewelpurchaseartician", {
      id: id
    });
  }
  ...
  function callDeleteJewellaryPurchaseApi() {
    if(validateDelete()){
      ...
      .post(
        Config.getCommonUrl() +
        "api/stockJVJewelleryPurchaseArtician/" +
      ...
      .catch((error) => {
        handleError(error, dispatch, {
          api: "api/stockJVJewelleryPurchaseArtician/" +
            selectedIdForDelete , body
        })
      });
      handleClose()
        ...
        <div className="flex flex-col md:flex-row container">
          <div className="flex flex-1 flex-col min-w-0" style={{ marginTop: "30px" }}>
            ...
            >
              <Grid item xs={12} sm={6} md={6} key="1">
                <FuseAnimate delay={300}>
                  <Typography className="text-18 font-700">
                    Jewellery Purchase (Artician Receive Stock Journal Voucher)
                  </Typography>
                </FuseAnimate>
              </Grid>
              <Grid
              ...
              >
                <Link
                  to="/dashboard/sales/stockjewelpurchaseartician/addstockjewelpurchaseartician"
            ...
            <div className="mt-16 department-tbl-mt-dv repairedissue-table )">
...
export default StockJewelPurchaseArtician;
