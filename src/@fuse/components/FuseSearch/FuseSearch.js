...
function FuseSearch(props)
{
    ...
    {
        dispatch({type: "open"});
        document.addEventListener("keydown", escFunction, { passive: false});
    }

    function hideSearch()
    {
        dispatch({type: "close"});
        document.removeEventListener("keydown", escFunction, { passive: false});
    }
                ...
                <div className={clsx(classes.root, "flex", props.className)}>
                    ...
                    {state.opened && (
                        <ClickAwayListener onClickAway={handleClickAway}>
                            <Paper
                                className="absolute left-0 right-0 h-full search-navbar-blg z-9999"
                                square={true}
                            >
...
FuseSearch.defaultProps = {
    trigger: (<IconButton className="w-64 h-64"  tabIndex="2"><Icon><img src=
    {Icones.search_grey} alt="" /></Icon></IconButton>),
